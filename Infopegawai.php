...
class Infopegawai {
    ...
    public function getRiwayatJabatanStruktural($nrk,$ug,$id){
        ...
        $sql = "SELECT
                ...
                a.KOJAB, c.NAJABL, a.USER_ID, to_char(a.TG_UPD, 'DD-MM-YYYY HH24:MM:SS') TG_UPD, a.TERM, a.STATUS, a.USER_ID,d.NAPANG,d.GOL,a.ESELON,a.KLOGAD,a.STATUS_FILE_UPLOAD,a.FILE_UPLOAD,a.SPMU,f.NALOKL as NAKLOGAD,g.NAMA AS NAMA_SPM,a.PEJTT,h.KETERANGAN as KET_PEJTT,to_char(a.TMTPENSIUN, 'YYYY-MM-DD') TMTPENSIUN,a.KREDIT,a.JENIS_SK,i.KETERANGAN AS KET_JENSK,a.KETERANGAN as KET_HIST
...
// AND a.DELETED IS NULL
        ...
        foreach($query->result() as $row){
            $table .= "<tr>";
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/jabatan/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_jbtn/".$row->NRK."/".$row->KOLOK."/".$row->KOJAB."/".$row->FILE_UPLOAD."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_jbtn/".$row->NRK."/".$row->KOLOK."/".$row->KOJAB."/".$row->FILE_UPLOAD."/3' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                ...
                {
                    $tmte = date('d-m-Y', strtotime($row->TMT));
                     $kutib = '"';
                     $table .= "  
                                <a href='".site_url()."file/upload/jabatan/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/reset_file/jabatan/".$row->FILE_UPLOAD."/".$row->NRK."/".$row->KOLOK."/".$row->KOJAB."/".$tmte."' onclick=".$kutib."return confirm('Apa anda yakin akan mereset data ini?');".$kutib." class='btn btn-xs btn-success'  title='Reset File Upload'>
                ...
                {
                     $table .= " <a href='' class='btn btn-xs btn-primary' disabled> Revisi </a>  ";  
                }
    ...
    public function getRiwayatJabatanStrukturalPeg($nrk,$ug,$id){
        ...
        $sql = "SELECT
                a.NRK, to_char(a.TMT, 'YYYY-MM-DD') TMT, a.NOSK, to_char(a.TGSK, 'YYYY-MM-DD') TGSK, a.KOLOK, b.NALOKL,
                a.KOJAB, c.NAJABL, a.USER_ID, to_char(a.TG_UPD, 'DD-MM-YYYY HH24:MM:SS') TG_UPD, a.TERM, a.STATUS, a.USER_ID,d.NAPANG,d.GOL,a.ESELON,a.FILE_UPLOAD,a.STATUS_FILE_UPLOAD,a.KLOGAD,a.SPMU,f.NALOKL as NAKLOGAD,g.NAMA AS NAMA_SPM,a.PEJTT,h.KETERANGAN as KET_PEJTT,to_char(a.TMTPENSIUN, 'YYYY-MM-DD') TMTPENSIUN,a.KREDIT,a.JENIS_SK,i.KETERANGAN AS KET_JENSK,a.KETERANGAN as KET_HIST
                FROM PERS_JABATAN_HIST a
                LEFT JOIN PERS_LOKASI_TBL b ON a.KOLOK = b.KOLOK
                LEFT JOIN PERS_KOJAB_TBL c ON a.KOJAB = c.KOJAB AND a.KOLOK = c.KOLOK
                LEFT JOIN PERS_PANGKAT_TBL d ON a.KOPANG = d.KOPANG
...
// AND a.DELETED IS NULL
        ...
        $table .= " <tr>
                        ...
                        <th width='15%'>Lokasi Gaji</th>
                        <th width='15%'>SKPD</th>
                        <th width='10%'>Pangkat (Gol)</th>
                        <th width='5%'>Eselon</th>
                        <th width='10%'>Jenis SK</th>
                        <th width='10%'>No SK<br/><strong><small class='text-navy'>(Tgl. SK)</small></strong></th>
                        <th width='10%'>Pejabat Penanda Tangan</th>
        ...
        foreach($query->result() as $row){
            $table .= "<tr>";
                $table .= "<td width='3%'>".$i."</td>";
                    $tmt = date('d-m-Y', strtotime($row->TMT));
                $table .= "<td width='3%'>".$tmt."</td>";
                $table .= "<td width='30%'>".$row->NALOKL."</td>";
                ...
                if($row->STATUS_FILE_UPLOAD == 2)
                {
                     $table .= " <td>  
                                    <a href='".site_url()."file/upload/jabatan/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-mini btn-warning' >
                                        <i class='fa fa-search'></i> 
                                    </a> 
                                </td>";
                }
                else
                {
                    ...
                    //     $kutib = '"';
                    //     $table .= "<td>  
                    //                 <a href='".site_url()."file/upload/jabatan/".$row->FILE_UPLOAD."' class='btn btn-mini btn-warning' >
                    //                     <i class='fa fa-search'></i> 
                    //                 </a>
                    //                 <a href='".site_url()."riwayat/stat_riw_jbtn/".$row->NRK."/".$row->KOLOK."/".$row->KOJAB."/".$row->FILE_UPLOAD."/2' class='btn btn-mini btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib.">
                    //                     <i class='fa fa-check'></i> 
                    //                 </a>
                    //                 <a href='".site_url()."riwayat/stat_riw_jbtn/".$row->NRK."/".$row->KOLOK."/".$row->KOJAB."/".$row->FILE_UPLOAD."/3' class='btn btn-mini btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib.">
                    //                     <i class='fa fa-remove'></i> 
                    //                 </a>
                    //             </td>";  
                    // }
                    ...
                    // elseif($row->STATUS_FILE_UPLOAD == 3)
                    // {
                    //      $table .= "<td> <a href='' class='btn btn-mini btn-primary' disabled> Revisi </a> </td>";  
                    // }
    ...
    public function getRiwayatJabatanFungsional($nrk,$ug,$id){
        ...
        $sql = "SELECT
                a.NRK, to_char(a.TMT, 'YYYY-MM-DD') TMT,a.FILE_UPLOAD,a.STATUS_FILE_UPLOAD, a.NOSK, to_char(a.TGSK, 'YYYY-MM-DD') TGSK, a.KOLOK, b.NALOKL,
        ...
        foreach($query->result() as $row){
            $table .= "<tr>";
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/jabatan_fungsional/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_jbtn_func/".$row->NRK."/".$row->KOJAB."/".$row->KOLOK."/".$row->TMT."/".$row->FILE_UPLOAD."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                 <a href='".site_url()."riwayat/stat_riw_jbtn_func/".$row->NRK."/".$row->KOJAB."/".$row->KOLOK."/".$row->TMT."/".$row->FILE_UPLOAD."/3' class='btn btn-xs btn-danger' onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
                ...
                {
                     $table .= "  
                                <a href='".site_url()."file/upload/jabatan_fungsional/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                             ";  
                }
    ...
    public function getRiwayatPendidikanFormal($nrk,$ug,$id){
        ...
        foreach($query->result() as $row){
            $table .= "<tr>";
                ...
                {
                     $table .= " <td>  
                                    <a href='".site_url()."file/upload/pendidikan_formal/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-mini btn-warning' >
                                        <i class='fa fa-search'></i> 
                                    </a> 
                                </td>";
                }
        ...
        foreach($query->result() as $row){
            $table .= "<tr>";
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/pendidikan_formal/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_pendidikan_formal/".$row->NRK."/".$row->JENDIK."/".$row->KODIK."/".$row->FILE_UPLOAD."/2/".$row->TGIJAZAH."' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_pendidikan_formal/".$row->NRK."/".$row->JENDIK."/".$row->KODIK."/".$row->FILE_UPLOAD."/3/".$row->TGIJAZAH."' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
                ...
                {
                     $table .= "  
                                <a href='".site_url()."file/upload/pendidikan_formal/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                             ";  
                }
...
// AND A.DELETED IS NULL
    ...
    public function getRiwayatPendidikanNonFormal($nrk,$ug,$id){
        ...
        $sql = "SELECT A.NRK, TO_CHAR(A.TGIJAZAH,'DD-MM-YYYY') AS TGIJAZAH, A.NOIJAZAH, A.FILE_UPLOAD, A.STATUS_FILE_UPLOAD, A.NASEK, A.UNIVER, A.USER_ID, A.TERM, A.TG_UPD, A.JENDIK, A.KODIK,
...
// AND a.DELETED IS NULL
        ...
        foreach($query->result() as $row){
            $table .= "<tr>";
                ...
                {
                     $table .= " <td>  
                                    <a href='".site_url()."file/upload/pendidikan_non_formal/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-mini btn-warning' >
                                        <i class='fa fa-search'></i> 
                                    </a> 
                                </td>";
                }
    ...
    public function getRiwayatPendidikanNonFormal2($nrk,$ug,$id){
        ...
        $accDel=$access['mnac']->act_delete;
        // $accDelFlag=$access['mnac']->act_delete_flag;
        $sql = "SELECT A.NRK, TO_CHAR(A.TGIJAZAH,'DD-MM-YYYY') AS TGIJAZAH, A.FILE_UPLOAD, A.STATUS_FILE_UPLOAD, A.NOIJAZAH, A.NASEK, A.UNIVER, A.USER_ID, A.TERM, A.TG_UPD, A.JENDIK, A.KODIK,
        ...
        foreach($query->result() as $row){
            $table .= "<tr>";
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/pendidikan_non_formal/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_pendidikan_non_formal/".$row->NRK."/".$row->JENDIK."/".$row->KODIK."/".$row->FILE_UPLOAD."/2/".$row->TGIJAZAH."' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_pendidikan_non_formal/".$row->NRK."/".$row->JENDIK."/".$row->KODIK."/".$row->FILE_UPLOAD."/3/".$row->TGIJAZAH."' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
                ...
                {
                    $table .= "  
                                <a href='".site_url()."file/upload/pendidikan_non_formal/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                             ";  
                }
...
//        $table .= "</tbody>";
    ...
    public function getRiwayatPangkat($nrk,$ug,$id){
        ...
        $sql = "SELECT KO.NRK,TO_CHAR(KO.TMT, 'DD-MM-YYYY') TMT, KO.NOSK, TO_CHAR(KO.TGSK, 'DD-MM-YYYY') TGSK, KO.KOPANG,
                KO.TTMASKER, KO.BBMASKER, TB.GOL, TB.NAPANG,KO.STATUS_FILE_UPLOAD,KO.FILE_UPLOAD, KO.KOLOK, LO.NALOKL, KO.GAPOK, TO_CHAR(KO.TG_UPD, 'DD-MM-YYYY HH24:MI:SS') TG_UPD, KO.USER_ID,KO.KLOGAD,LG.NALOKL AS NAKLOGAD,KO.SPMU, SP.NAMA AS NAMA_SPM,f.KETERANGAN AS KET_PEJTT,g.KETERANGAN AS KET_JENRUB,KO.JENRUB,KO.KETERANGAN as KET_HIST
...
//                    $tmt = date('d M Y', strtotime($row->TMT));
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/pangkat/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_pangkat/".$row->NRK."/".$row->KOPANG."/".$row->GAPOK."/".$row->FILE_UPLOAD."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_pangkat/".$row->NRK."/".$row->KOPANG."/".$row->GAPOK."/".$row->FILE_UPLOAD."/3' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
                ...
                {
                     $table .= "  
                                <a href='".site_url()."file/upload/pangkat/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                             ";  
                }
...
//                    $tmt = date('d M Y', strtotime($row->TMT));
    ...
    public function getRiwayatGapok($nrk,$ug,$id){
        ...
        $sql = "SELECT a.NRK, to_char(a.TMT, 'YYYY-MM-DD') TMT, a.NOSK, to_char(a.TGSK, 'DD-MM-YYYY') TGSK, a.KOPANG,a.TTMASKER, a.BBMASKER, b.NAPANG, b.GOL, a.GAPOK,a.STATUS_FILE_UPLOAD,a.FILE_UPLOAD, a.KOLOK, c.NALOKL,d.KETERANGAN, to_char(a.TG_UPD, 'DD-MM-YYYY HH24:MI:SS') TG_UPD, a.USER_ID,a.KLOGAD,a.SPMU,e.NALOKL AS NAKLOGAD,f.NAMA AS NAMA_SPM,a.TAHUN_REFGAJI,a.KETERANGAN as KET_HIST
...
//                    $tgsk = date('d M Y', strtotime($row->TGSK));
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/gapok/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_gapok/".$row->NRK."/".$row->TMT."/".$row->GAPOK."/".$row->FILE_UPLOAD."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_gapok/".$row->NRK."/".$row->TMT."/".$row->GAPOK."/".$row->FILE_UPLOAD."/3' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
                ...
                {
                     $table .= "  
                                <a href='".site_url()."file/upload/gapok/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                             ";  
                }
...
//                    $tgsk = date('d M Y', strtotime($row->TGSK));
    ...
    public function getHukumanDisiplin($nrk,$ug,$id){
        ...
        $sql = "SELECT a.NRK, a.FILE_UPLOAD,a.STATUS_FILE_UPLOAD, to_char(a.TGSK, 'YYYY-MM-DD') TGSK, a.NOSK, b.KETERANGAN,
...
//                    $akhir = date('d M Y', strtotime($row->TGAKHIR));
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    ...
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/hukdis/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_hukdis/".$row->NRK."/".$TGSK."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                 <a href='".site_url()."riwayat/stat_riw_hukdis/".$row->NRK."/".$TGSK."/3' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
                ...
                {
                     $table .= "  
                                <a href='".site_url()."file/upload/hukdis/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                             ";  
                }
...
//                    $akhir = date('d M Y', strtotime($row->TGAKHIR));
    ...
    public function getRiwayatSKP($nrk,$ug,$id){
        ...
        $accDel=$access['mnac']->act_delete;
        // $accDelFlag=$access['mnac']->act_delete_flag;
        $sql = "SELECT NRK,TAHUN,PELAYANAN,FILE_UPLOAD,STATUS_FILE_UPLOAD,INTEGRITAS, KOMITMEN,DISIPLIN, KERJASAMA, KEPEMIMPINAN, JUMLAH,RATA2, NILAI_SKP,NILAI_PERILAKU,NILAI_PRESTASI,STATUS_VALIDASI, USERID_INPUT,       
        ...
        foreach($query->result() as $row){
            ...
            $table .= "<tr>";
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/skp/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_skp/".$row->NRK."/".$row->TAHUN."/".$row->FILE_UPLOAD."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_skp/".$row->NRK."/".$row->TAHUN."/".$row->FILE_UPLOAD."/3' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
                ...
                {
                     $table .= "  
                                <a href='".site_url()."file/upload/skp/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                             ";  
                }
    ...
    public function getRiwayatCuti($nrk,$ug,$id){
        ...
        $sql = "SELECT
                  a.NRK,a.FILE_UPLOAD,a.STATUS_FILE_UPLOAD, to_char(a.TMT, 'YYYY-MM-DD') TMT, a.NOSK, to_char(a.TGSK, 'YYYY-MM-DD') TGSK, b.KETERANGAN,A .JENCUTI,A .ID_HIST,A .STATUS_CUTI,to_char(a.TGAKHIR, 'DD-MM-YYYY') TGAKHIR, to_char(a.TG_UPD, 'DD-MM-YYYY HH24:MI:SS') TG_UPD,a.USER_ID,c.KETERANGAN AS KET_PEJTT,a.KETERANGAN as KET_HIST
...
//                    $tgakhir = date('d M Y', strtotime($row->TGAKHIR));
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    ...
                    $kutib = '"';
                    $table .= "  
                                <a href='".site_url()."file/upload/cuti/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                    <i class='fa fa-search'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_cuti/".$row->NRK."/".$tmt."/".$row->JENCUTI."/".$row->TGAKHIR."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                               <a href='".site_url()."riwayat/stat_riw_cuti/".$row->NRK."/".$tmt."/".$row->JENCUTI."/".$row->TGAKHIR."/3' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
                ...
                {
                     $table .= "  
                                <a href='".site_url()."file/upload/cuti/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                    <i class='fa fa-search'></i> 
                                </a>
                             ";  
                }
...
//        $table .= "</tbody>";
    ...
    public function getRiwayatPenghargaan($nrk,$ug,$id){
        ...
        $sql = "SELECT
                  a.NRK, a.KDHARGA,a.FILE_UPLOAD,a.STATUS_FILE_UPLOAD, b.NAHARGA, a.TGSK, a.NOSK, a.ASAL_HRG,
            ...
            $table .= "<tr>";
                ...
                if($row->STATUS_FILE_UPLOAD == 1)
                {
                    ...
                    $table .= "  
                                ...
                                <a href='".site_url()."riwayat/stat_riw_penghargaan/".$row->NRK."/".$row->KDHARGA."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                    <i class='fa fa-check'></i> 
                                </a>
                                <a href='".site_url()."riwayat/stat_riw_penghargaan/".$row->NRK."/".$row->KDHARGA."/3' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                    <i class='fa fa-remove'></i> 
                                </a>
                             ";  
                }
    ...
    public function getRiwayatHubunganKeluarga($nrk,$ug,$id){
        ...
        $sql = "SELECT
                  a.NRK, a.HUBKEL,a.FILE_UPLOAD,a.STATUS_FILE_UPLOAD, b.NAHUBKEL, a.NAMA, a.TEMHIR, to_char(a.TALHIR, 'YYYY-MM-DD') TALHIR,
    ...
    public function getRiwayatHubunganKeluarga2($nrk,$ug,$id,$session_data){
        ...
        $sql = "SELECT
                  a.NRK, a.FILE_UPLOAD,a.STATUS_FILE_UPLOAD, a.HUBKEL, b.NAHUBKEL, a.NAMA, a.TEMHIR, to_char(a.TALHIR, 'YYYY-MM-DD') TALHIR,
                  a.TGNIKAH AS TGNIKAH1, to_char(a.TGNIKAH, 'YYYY-MM-DD') TGNIKAH, to_char(a.TGAKTECERAI, 'DD-MM-YYYY')TGAKTECERAI, to_char(a.TGSURATCERAI, 'DD-MM-YYYY')TGSURATCERAI, a.TEMNIKAH, c.KETERANGAN TUNJANGAN, d.KETERANGAN KERJAAN,
                  a.JENKEL, to_char(a.MATI, 'DD-MM-YYYY') MATI, a.UANGDUKA,e.KET_STATUS,
                  to_char(a.TG_UPD, 'DD-MM-YYYY HH24:MI:SS') TG_UPD, a.USER_ID,a.KETERANGAN as KET_HIST
                FROM PERS_KELUARGA a
                 ...
                 if($row->STATUS_FILE_UPLOAD == 1)
                    {
                        ...
                        $kutib = '"';
                        $table .= "  
                                    <a href='".site_url()."file/upload/hubkel/".$row->FILE_UPLOAD."' class='btn btn-xs btn-warning'  title='Lihat File' target='_blank' >
                                        <i class='fa fa-search'></i> 
                                    </a>
                                    <a href='".site_url()."riwayat/stat_riw_hubkel/".$row->NRK."/".$row->HUBKEL."/2' class='btn btn-xs btn-info' onclick=".$kutib."return confirm('Apa Anda yakin akan Approve Riwayat Ini???');".$kutib."  title='Approve'>
                                        <i class='fa fa-check'></i> 
                                    </a>
                                    <a href='".site_url()."riwayat/stat_riw_hubkel/".$row->NRK."/".$row->HUBKEL."/3' class='btn btn-xs btn-danger'  onclick=".$kutib."return confirm('Apa Anda yakin akan Tolak Riwayat Ini???');".$kutib."  title='Tolak'>
                                        <i class='fa fa-remove'></i> 
                                    </a>
                                 ";  
                    }
                    ...
                    {
                         $table .= "  
                                    <a href='".site_url()."file/upload/hubkel/".$row->FILE_UPLOAD."' target='_blank' class='btn btn-xs btn-warning'  title='Lihat File'>
                                        <i class='fa fa-search'></i> 
                                    </a>
    ...
    public function getPendidikanHistBy($nrk,$jendik,$kodik,$tgijazah=""){
        ...
        if($jendik==1){ #pendidikan formal
         $sql = "SELECT NRK, JENDIK, KODIK, NASEK, UNIVER,FILE_UPLOAD,STATUS_FILE_UPLOAD, KOTSEK, to_char(TGIJAZAH, 'DD-MM-YYYY') TGIJAZAH, NOIJAZAH,
                to_char(TGACCKOP, 'DD-MM-YYYY') TGACCKOP, NOACCKOP, to_char(TGMULAI, 'DD-MM-YYYY') TGMULAI, 
