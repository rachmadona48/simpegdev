...
class Laporan extends CI_Controller {
	...
	{  
           ...
           // var_dump( $data['nrk']);
            ...
            $data['ka_bkd'] = $this->referensi->ka_bkd();  
...
';
   ...
   /*     $v1s = $this->uri->segment(4, 0);
    ...
    /*    $v2s = $this->uri->segment(4, 0);
        $v2=urldecode($v2s);

        $v3s = $this->uri->segment(5, 0);
        $v3=urldecode($v3s);

        $v4s = $this->uri->segment(6, 0);
        $v4=urldecode($v4s);

        $v5s = $this->uri->segment(8, 0);
        $v5=urldecode($v5s);

        $v6s = $this->uri->segment(7, 0);
        $v6=urldecode($v6s);

        $v7s = $this->uri->segment(8, 0);
        $v7=urldecode($v7s);

        $valnrk = $this->uri->segment(9, 0);
*/
        ...
        $report = $compileManager->compileReport($folderPath . "Rnewberkala.jrxml");
    ...
    function berkalaallpdf()
    {
		//echo 'cetaks';exit();
        $this->load->helper('download');

//            force_download('assets/pdf/newberkala.pdf',NULL);    
            //header("Cache-Control: no-store, no-cache, must-revalidate"); //HTTP 1.1
            //header("Pragma: no-cache"); //HTTP 1.0
            //header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); // Date in the past
            header('Content-Type: application/pdf');
            header('Content-Disposition: attachment; filename=newberkala.pdf');
            header('Content-Transfer-Encoding: binary');
            header('Accept-Ranges: bytes');
        
             readfile('assets/pdf/newberkala.pdf');
    ...
    function bkltemp() {
        ...
        $report = $compileManager->compileReport($folderPath . "newberkala_2.jrxml");
...
//            force_download('assets/pdf/newberkala.pdf',NULL);    
            ...
            header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); // Date in the past
            header('Content-Type: application/pdf');
            header('Content-Disposition: attachment; filename=newberkalatemp.pdf');
            header('Content-Transfer-Encoding: binary');
            header('Accept-Ranges: bytes');
        
             readfile('assets/pdf/newberkalatemp.pdf');

    }

    function bklspmutemp() {
        ...
        $report = $compileManager->compileReport($folderPath . "newberkalaspmu_2.jrxml");
        ...
        $filename = "newberkalaspmutemp.pdf";
        $outputPath = realpath(".") . "/assets/pdf/" . $filename;
...
//            force_download('assets/pdf/newberkala.pdf',NULL);    
            ...
            header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); // Date in the past
            header('Content-Type: application/pdf');
            header('Content-Disposition: attachment; filename=newberkalaspmutemp.pdf');
            header('Content-Transfer-Encoding: binary');
            header('Accept-Ranges: bytes');
        
             readfile('assets/pdf/newberkalaspmutemp.pdf');
    ...
    function bklspmu() {
        ...
        $report = $compileManager->compileReport($folderPath . "Rnewberkalaspmu.jrxml");
    ...
    function berkalaspmupdf()
    {
        $this->load->helper('download');
        //force_download('assets/pdf/newberkalaspmu.pdf',NULL);

        header("Cache-Control: no-store, no-cache, must-revalidate"); //HTTP 1.1
        header("Pragma: no-cache"); //HTTP 1.0
        header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); // Date in the past
        header('Content-Type: application/pdf');
        header('Content-Disposition: attachment; filename=newberkalaspmu.pdf');
        header('Content-Transfer-Encoding: binary');
        header('Accept-Ranges: bytes');
    
         readfile('assets/pdf/newberkalaspmu.pdf');
    ...
    function cetakAllDPCPPDF()
    {
        ...
        header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); // Date in the past
        header('Content-Type: application/pdf');
        header('Content-Disposition: attachment; filename=newdpcp.pdf');
        header('Content-Transfer-Encoding: binary');
        header('Accept-Ranges: bytes');
    
         readfile('assets/pdf/newdpcp.pdf');
    ...
    function cetakDPCPSPMUPDF() {
        ...
        header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); // Date in the past
        header('Content-Type: application/pdf');
        header('Content-Disposition: attachment; filename=newdpcpspmu.pdf');
        header('Content-Transfer-Encoding: binary');
        header('Accept-Ranges: bytes');
    
         readfile('assets/pdf/newdpcpspmu.pdf');
    }

    function cetakBerkalaNRK2()
    {
        if(isset($_POST['nrkP']))
        {
            $nrkP = $_POST['nrkP'];
        ...
        $report = $compileManager->compileReport($folderPath . "Rnewberkalanrk.jrxml");
