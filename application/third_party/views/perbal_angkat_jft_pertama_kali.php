...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PENGANGKATAN PERTAMA KALI PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' PANGKAT/GOLONGAN RUANG '.$napang.'/'.$gol.' DALAM JABATAN FUNGSIONAL '.$najabl.' dan '.$nm_tingkat.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA.</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Mengangkat Pertama Kali Pegawai Negeri Sipil dalam Jabatan Fungsional '.$najabl.'/'.$nm_tingkat.' dengan angka kredit '.$angka_kredit.' ('.$angka_kredit_words.').<br/><br/>
