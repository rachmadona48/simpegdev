    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="ibox float-e-margins">
                        ...
                        <h3>Selamat Datang di SIMPEG</h3>
                        ...
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body" id="pan1">
                                ...
                                foreach($isiInformasiBaru as $row)
                                {
                                    ...
                                    echo "<b><font color='#0c29f9'>".$row->BERITA." </font></b>";
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
               Copyright <strong>BKD Pemprov DKI Jakarta</strong><small> © <?php echo date('Y')?><br/>Jalan Merdeka Selatan Kav 8-9 Gedung Balaikota Lantai 3 dan 13 Jakarta</small>
            </div>
        </div>
    </div>
</body>
