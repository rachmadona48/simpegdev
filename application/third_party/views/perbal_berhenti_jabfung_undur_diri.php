...
<table>
  <tr>
    ...
    <td style="width:75%">
      <ol type="a">
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan hasil penelitian administrasi dan surat pernyataan tanggal ........... hal....... Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.', menyatakan mengundurkan diri dari jabatan '.$najabl.' dan untuk kepentingan dinas perlu memberhentikan dari jabatan fungsional '.$najabl.' pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a, perlu menetapkan Keputusan Gubernur tentang Pemberhentian Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.' dari Jabatan Fungsional '.$najabl.' dan '.$nm_tingkat.' pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
      </ol>
    </td>
  </tr>
  <tr>
...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PEMBERHENTIAN PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.', NIP/NRK '.$nip.'/'.$nrk.' PANGKAT/GOLONGAN RUANG '.$napang.'/'.$gol.' DARI JABATAN FUNGSIONAL '.$najabl.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Pemberhentian Pegawai Negeri Sipil dari jabatan fungsional '.$najabl.' dengan angka kredit sebesar '.$angka_kredit.' ('.$angka_kredit_words.').<br/><br/>
