    ...
    <div class="col-lg-4">
        <div class="ibox float-e-margins text-center">
            ...
            <div class="ibox-content">
                ...
                <a href="<?php echo base_url('subbid/permohonan3') ?>" class="btn btn-info btn-lg btn-block"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>                    
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="ibox float-e-margins text-center">
            ...
            <div class="ibox-content">
                <h2><?php echo $jumlah_permohonan_tolak3->TRX_TOLAK; ?> PERMOHONAN</h2><br/>
                <a href="<?php echo base_url('subbid/dashboard_tolak3') ?>" class="btn btn-info btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></a>                    
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="ibox float-e-margins text-center">
            ...
            <div class="ibox-content">
                ...
                <a href="<?php echo base_url('subbid/dashboard_terima3') ?>" class="btn btn-info btn-lg btn-block"><i class="fa fa-check" aria-hidden="true"></i></a>                    
            </div>
        </div>
    </div>
</div>