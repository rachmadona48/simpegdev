...
<table>
  <tr>
    ...
    <td style="width:75%">
      <ol type="a">
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan hasil penelitian administrasi, Pegawai Negeri Sipil Atas Nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.', telah memenuhi syarat untuk diangkat dalam Jabatan Fungsional '.$najabl.' melalui penyesuaian/Inpassing pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PENYESUAIAN/INPASSING PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' PANGKAT/GOLONGAN RUANG '.$napang.'/'.$gol.' DALAM JABATAN FUNGSIONAL '.$najabl.' dan '.$nm_tingkat.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Menyesuaikan Pegawai Negeri Sipil dalam jabatan fungsional '.$najabl.' dan '.$nm_tingkat.', dengan angka kredit sebesar '.$angka_kredit.' ('.$angka_kredit_words.').<br/><br/>
