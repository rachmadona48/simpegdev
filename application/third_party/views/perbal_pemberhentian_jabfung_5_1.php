...
<tr>
<td width="15%"></td>
<td width="70%" align="center">PEMBERHENTIAN PEGAWAI NEGERI SIPIL ATAS NAMA $nama_pegawai NIP/NRK

$nip/$nrk PANGKAT/GOLONGAN RUANG $pangkat/$golongan DARI JABATAN FUNGSIONAL

$(NAMA JENIS JABATAN FUNGSIONAL) PADA $(NAMA SKPD)
...
<table border="0" width="100%">
	<tbody>
		<tr>
			...
			<td width="75%" align="justify">bahwa berdasarkan hasil penelitian administrasi dan Surat Keputusan

Gubernur Nomor $nomor Tentang $(Pembebasan Sementara), Pegawai Negeri Sipil

atas nama $nama_pegawai NIP/NRK $nip/$nrk Pangkat/Golongan Ruang $pangkat/$golongan, telah

diberikan waktu 1 (satu) tahun untuk mengumpulkan Angka Kredit untuk kenaikan

pangkat dan atau jenjang jabatan fungsional $(Nama Jabatan Fungsional),

namun tidak dapat memperoleh angka kredit yang dipersyaratkan dan untuk

kepentingan dinas dipandang perlu untuk memberhentikan yang bersangkutan dari

jabatan fungsional $(Nama Jabatan Fungsional) pada $(Nama

SKPD) Provinsi Daerah Khusus Ibukota Jakarta;</td>
		</tr>
		...
		<tr>
			...
			<td valign="top">&nbsp;</td>
			<td valign="top">b.</td>
			<td align="justify">bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a, perlu

menetapkan Keputusan Gubernur tentang Pemberhentian Pegawai Negeri Sipil

atas nama $nama_pegawai NIP/NRK $nip/$nrk Pangkat/Golongan Ruang $pangkat/$golongan dari

Jabatan Fungsional $(Nama dan Jenjang Jabatan Fungsional) pada $(Nama SKPD) Provinsi Daerah Khusus Ibukota Jakarta;</td>
		</tr>
...
<table border="0" width="100%">
	<tbody>
		<tr>
			...
			<td width="80%" align="justify">Peraturan Presiden Nomor $nomor tentang Tunjangan Jabatan Fungsional $(Nama Jenis Jabatan Fungsional);</td>
		</tr>
		<tr>
			<td></td><td></td><td></td><td></td>
		</tr>
...
<table border="0" width="100%">
	...
	<tr>
		...
		<td valign="top" width="2%">:</td>
		<td width="80%" align="justify">KEPUTUSAN GUBERNUR TENTANG PEMBERHENTIAN PEGAWAI NEGERI

SIPIL ATAS NAMA $nama_pegawai NIP/NRK $nip/$nrk PANGKAT/GOLONGAN RUANG

$pangkat/$golongan DARI JABATAN FUNGSIONAL $(Nama Jenis Jabatan Fungsional)
...
PADA $(Nama SKPD) PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA</td>
	...
	<tr>
		...
		<td valign="top">:</td>
		<td align="justify">Pemberhentian Pegawai Negeri Sipil dari jabatan
...
diberikan tunjangan jabatan fungsional $(Nama Jenis Jabatan Fungsional)
...
$this->pdf_report3->Output('perbal_pemberhentian_jabfung_5_1.pdf', 'I');
