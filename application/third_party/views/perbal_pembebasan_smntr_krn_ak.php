...
<table>
  <tr>
    ...
    <td style="width:75%">
      <ol type="a">
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan hasil penelitian administrasi dan Surat Kepala Kantor Regional V Badan Kepegawaian Negara Nomor 0239/KRV.25/III/20105 Hal Penjelasan Jabatan Fungsional, dan untuk kepentingan dinas perlu membebaskan sementara Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.' dari Jabatan Fungsional '.$najabl.' dan '.$nm_tingkat.' pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
        <li style="text-align:justify; line-height:150%">bahwa sesuai ketentuan Pasal ..... Keputusan Menteri Pendayagunaan  Jabatan Fungsional '.$najabl.' dan Angka Kreditnya dinyatakan bahwa '.$najabl.' dibebaskan sementara dari Jabatannya apabila dalam jangka waktu 5 (lima) tahun sejak diangkat dalam pangkat terakhir tidak dapat mengumpulkan angka kredit untuk kenaikan pangkat/jabatan setingkat lebih tinggi;</li>
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a dan huruf b, perlu menetapkan Keputusan Gubernur tentang Pembebasan Sementara Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.' dari Jabatan Fungsional '.$najabl.' dan '.$nm_tingkat.' pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
      </ol>
    </td>
  </tr>
  <tr>
...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PEMBEBASAN SEMENTARA PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' PANGKAT/GOLONGAN RUANG '.$napang.'/'.$gol.' DARI JABATAN FUNGSIONAL '.$najabl.' dan '.$nm_tingkat.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA.</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Membebaskan Pegawai Negeri Sipil dari jabatan fungsional '.$najabl.' dengan angka kredit sebesar '.$angka_kredit.' ('.$angka_kredit_words.').<br/><br/>
  ...
  <tr>
    <td>KEDUA</td>
    <td>:</td>
    <td style="line-height:150%">Pembebasan sementara ini berlaku selama 1 (satu) tahun terhitung sejak tanggal di tetapkan dan Pegawai Negeri Sipil sebagaimana di maksud pada diktum KESATU dapat di angkat kembali dalam jabatan fungsional '.$najabl.', apabila dalam masa pembebasan sementara dapat mengumpulkan angka kredit untuk kenaikan pangkat/jabatan setingkat lebih tinggi.</td>
  </tr>
  <tr>
    <td>KETIGA</td>
    <td>:</td>
    <td style="line-height:150%">Kepada Pegawai Negeri Sipil sebagaimana dimaksud pada diktum KESATU diberhentikan tunjangan jabatan fungsional '.$najabl.' sesuai dengan ketentuan peraturan perundang-undangan.</td>
  </tr>
  <tr>
    <td>KETIGA</td>
    <td>:</td>
