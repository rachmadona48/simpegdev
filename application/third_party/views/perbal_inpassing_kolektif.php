...
<table>
  <tr>
    ...
    <td style="width:75%">
      <ol type="a">
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan hasil penelitian administrasi Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' dan kawan-kawan sebanyak '.$jumlah_orang.' orang, telah memenuhi syarat untuk diangkat dalam Jabatan Fungsional '.$najabl.' melalui inpassing/penyesuaian pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PENYESUAIAN/INPASSING PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' DAN KAWAN-KAWAN SEBANYAK '.$jumlah_orang.' DALAM JABATAN FUNGSIONAL '.$najabl.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA.</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Menyesuaikan Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' dan kawan-kawan sebanyak '.$jumlah_orang.' dalam jabatan fungsional '.$najabl.' pada '.$skpd.', dengan angka kredit sebagaimana terlampir dalam Keputusan Gubernur ini.</td>
  </tr>
  <tr>
    <td>KEDUA</td>
    <td>:</td>
  ...
  <tr>
    <td colspan="3">TEMBUSAN:
      <ol type="1">
        <li style="text-align:justify; line-height:150%">Gubernur Provinsi DKI Jakarta</li>
        <li style="text-align:justify; line-height:150%">Kepala Kantor Regional V BKN di Jakarta</li>
        <li style="text-align:justify; line-height:150%">Sekretaris Daerah Provinsi DKI Jakarta</li>
        <li style="text-align:justify; line-height:150%">Inspektur Provinsi DKI Jakarta</li>
        <li style="text-align:justify; line-height:150%">Kepala Badan Kepegawaian Daerah Provinsi DKI Jakarta</li>
        <li style="text-align:justify; line-height:150%">Kepala Badan Pengelola Keuangan Daerah Provinsi DKI Jakarta</li>
        <li style="text-align:justify; line-height:150%">Kepala '.$skpd.' SKPD Yang bersangkutan</li>
        <li style="text-align:justify; line-height:150%">Kepala Biro Umum Setda Provinsi DKI Jakarta</li>
      </ol>
    </td>
  </tr>
</table>
';
echo $html;
/*$this->pdf_isi_perbal->writeHTML($html_fix1, true, false, false, false, '');
ob_clean();
