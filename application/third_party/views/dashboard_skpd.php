        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins text-center">
                ...
                <div class="ibox-content">
                    <h2><?php echo $jumlah_permohonan->TRX_HDR; /*echo $jumlah_permohonan->COUNT(*)*/ ?> PEGAWAI</h2><br/>
                    <a href="<?php echo base_url('skpd/permohonan') ?>" class="btn btn-warning btn-lg btn-block"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>                    
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="ibox float-e-margins text-center">
                ...
                <div class="ibox-content">
                    <h2><?php echo $jumlah_permohonan_tolak->TRX_TOLAK; /*echo $jumlah_permohonan->COUNT(*)*/ ?> PEGAWAI</h2><br/>
                    <a href="<?php echo base_url('skpd/dashboard_tolak') ?>" class="btn btn-danger btn-lg btn-block"><i class="fa fa-times" aria-hidden="true"></i></a>                    
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="ibox float-e-margins text-center">
                ...
                <div class="ibox-content">
                    <h2><?php echo $jumlah_permohonan_terima->TRX_TERIMA; /*echo $jumlah_permohonan->COUNT(*)*/ ?> PERMOHONAN</h2><br/>
                    <a href="<?php echo base_url('skpd/dashboard_terima') ?>" class="btn btn-success btn-lg btn-block"><i class="fa fa-check" aria-hidden="true"></i></a>                    
                </div>
            </div>
        </div>
    </div>
