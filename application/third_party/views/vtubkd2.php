    ...
    <div id="myNav" class="overlay">
      ...
      <div class="overlay-content">
        <a href="#" id="cetak_cover_perbal">Cetak Cover Perbal</a>
        <a href="#" id="cetak_isi_perbal">Cetak Isi Perbal</a>
      </div>
...
<?php } ?>
    ...
    <script src="<?php echo base_url(); ?>assets/horizontal-timeline/js/main.js"></script>
        ...
        $(document).ready(function(){
            // function test(){
            //  $('a:contains(Isi Perbal)').each(function(index){
                
            //     $(this).attr('href','http://www.google.com');
            // })
            //  }
            // test();
            // $('a:contains(Isi Perbal)').attr('href',)
...
//                destroy: true,
                ...
                "serverSide": true,
                "ajax": {
                    url: '<?php echo base_url("index.php/tubkd/get_data_table"); ?>/4',
                    type: "post",
                     data: {
        ...
        /*function simpan_data(){
            ...
            $.ajax({
                url: '<?php //echo base_url("index.php/tubkd/simpan_data2") ?>',
                type: 'post',
                data: {
        ...
        function confirm()
        {
            ...
            {
                confirmKirimData(a,b,c);    
            }
            
        }


        function confirmKirimData(no_terima,id_trx_hdrp,tgl_terima){
                /*START SWEETALERT*/                
                    swal({
                        ...
                        if (isConfirm) {
                            simpanData(no_terima,id_trx_hdrp,tgl_terima);                            
                        }else
                        {
                            return false;
                        }                         
           ...
           function simpanData(no_terima,id_trx_hdrp,tgl_terima){
                var result = 0;

                $.ajax({
                    url: "<?php echo site_url('tubkd/simpan_data2')?>",
                    type: "post",
                    data: {no_terima:no_terima, id_trx_hdrp:id_trx_hdrp,tgl_terima:tgl_terima},
                    dataType: 'json',
                    beforeSend: function() {
