...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PENGANGKATAN PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' DAN KAWAN-KAWAN SEBANYAK '.$jumlah_orang.' DALAM JABATAN FUNGSIONAL '.$najabl.' PADA '.$skpd.' (NAMA SKPD) PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA.</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Mengangkat Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' dan kawan-kawan sebanyak '.$jumlah_orang.' dalam jabatan fungsional '.$najabl.' pada '.$skpd.', dengan angka kredit sebagaimana tercantum dalam Lampiran Keputusan Gubernur ini.</td>
  </tr>
  <tr>
    <td>KEDUA</td>
    <td>:</td>
