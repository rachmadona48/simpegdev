	            ...
	            <div class="ibox-content">
	            	<form id="defaultForm2" name="defaultForm2" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="tgsk" name="tgsk" placeholder="Tgsk" value="<?php echo isset($tgsk) ? $tgsk : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Jenhukdis</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="tgmulai" name="tgmulai" placeholder="Tgmulai" value="<?php echo isset($tgmulai) ? $tgmulai : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="tgakhir" name="tgakhir" placeholder="Tgakhir" value="<?php echo isset($tgakhir) ? $tgakhir : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
