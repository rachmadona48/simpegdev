            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="defaultForm2" name="defaultForm2" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Nama_dept</label>
                                <div class="col-sm-10">
                                    <input type="text" id="nama_dept" name="nama_dept" placeholder="Nama Dept" value="<?php echo isset($nama_dept) ? $nama_dept : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">                               
                                <div class="col-sm-4 col-sm-offset-2">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a href="<?php echo base_url(); ?>index.php/master/induk" class="btn btn-danger">Kembali</a>
                                        </div>                                      
                                    </div>
                                </div>                              
                                <div class="col-sm-4 col-sm-offset-2">
