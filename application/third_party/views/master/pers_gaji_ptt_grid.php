	...
	<div class="row">
        <div class="col-lg-12">
            <div class="contact-box">
            	<div>
					<a href="<?php echo base_url(); ?>index.php/master/gajiptt/doadd/" class="btn btn-success pull-right">
						<i class="glyphicon glyphicon-plus"></i> Tambah Gaji PTT
					</a>
				</div>
            	<div>
            		<div class="clearfix"></div>
            		<div class="table-responsive">
			            <table id="employee-grid" class="table table-striped table-bordered table-hover dt-responsive nowrap dataTables-example" width="100%" cellpadding="0" cellspacing="0" border="0" class="display">
								<thead>
									<tr>
										<th>NPTT</th>									
										<th>THBL</th>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {			
				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"ajax":{
						url :"<?php echo base_url(); ?>index.php/master/gajiptt/data", // json datasource
