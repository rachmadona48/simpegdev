...
<style type="text/css">
	...
	#employee-grid td:nth-child(8)
	{
		text-align: right !important;
	}
	#employee-grid td:nth-child(10)
	{
		text-align: right !important;
	}
	#employee-grid td:nth-child(12)
	{
		text-align: right !important;
	}
	#employee-grid td:nth-child(18)
	{
		text-align: right !important;
	}
	...
	<div class="row">
        <div class="col-lg-12">
            <div class="contact-box">
            	<div>
					<a href="<?php echo base_url(); ?>index.php/hist/tpp_ptt_hist/doadd/" class="btn btn-success pull-right">
						<i class="glyphicon glyphicon-plus"></i> Tambah TPP PTT History
					</a>
				</div>
            	<div>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {			
				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"ajax":{
						url :"<?php echo base_url(); ?>index.php/hist/tpp_ptt_hist/data", // json datasource
			...
			function hapusData(id1,id2, action){
				var dataTable = $('#employee-grid').DataTable();
				//var formData = {name:"ravi",age:"31"}; --> Example
				var formData = {nptt:id1,thbl:id2};
