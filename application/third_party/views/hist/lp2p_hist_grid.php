	...
	<div class="row">
        <div class="col-lg-12">
            <div class="contact-box">
            	<div>
					<a href="<?php echo base_url(); ?>index.php/hist/lp2p_hist/doadd/" class="btn btn-success pull-right">
						<i class="glyphicon glyphicon-plus"></i> Tambah LP2P History
					</a>
				</div>
            	<div>
		            ...
		            <table id="employee-grid" class="table table-striped table-bordered table-hover dt-responsive nowrap dataTables-example" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
							...
							<thead>
								<tr>
									...
									<th><input type="text" data-column="30"  class="search-input-text form-control"></th>
									<th><input type="text" data-column="31"  class="search-input-text form-control"></th>
									<th><input type="text" data-column="32"  class="search-input-text form-control"></th>
									<th><input type="text" data-column="33"  class="search-input-text form-control"></th>	
									<th><input type="text" data-column="34"  class="search-input-text form-control"></th>
									<th><input type="text" data-column="35"  class="search-input-text form-control"></th>
									<th><input type="text" data-column="36"  class="search-input-text form-control"></th>
									<th><input type="text" data-column="37"  class="search-input-text form-control"></th>				
									<th></th>
								</tr>
							</thead>
					</table>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {			
				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"ajax":{
						url :"<?php echo base_url(); ?>index.php/hist/lp2p_hist/data", // json datasource
			...
			function hapusData(id,id2, action){
				var dataTable = $('#employee-grid').DataTable();
				//var formData = {name:"ravi",age:"31"}; --> Example
				var formData = {id:id,id2:id2};
