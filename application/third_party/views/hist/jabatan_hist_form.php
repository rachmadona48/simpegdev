<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
        <h2>Jabatan History</h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Home</a>
            </li>
            <li class="active">
                <strong>jabatan_history_form</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
	            	...
	            	<form id="defaultForm2" name="defaultForm2" method="post" class="form-horizontal">
	            			...
	            			<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                      ...
                                      <div class="i-checks"><label> <input type="radio" name="status" <?php echo isset($STATUS) ? (($STATUS == 0) ? 'checked' : '') : ''; ?> value="0"> <i></i> Non-Aktif </label></div>
                                      <div class="i-checks"><label> <input type="radio" name="status" <?php echo isset($STATUS) ? (($STATUS == 1) ? 'checked' : '') : ''; ?> value="1"> <i></i> Aktif </label></div>
                                </div>
	            			...
	            			<div class="form-group">
	            				<label class="col-sm-2 control-label">CKOJABF</label>
                            	<div class="input-group col-sm-4">
                            		<input type="text" id="ckojabf" name="ckojabf" placeholder="CKOJABF" value="<?php echo isset($CKOJABF) ? $CKOJABF : ""; ?>" class="form-control">
                            	</div>
	                        </div>
	                        <div class="hr-line-dashed"></div>
	            			...
	            			<div class="form-group">                               
                                <div class="col-sm-4 col-sm-offset-2">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a href="<?php echo base_url(); ?>index.php/hist/jabatan_hist" class="btn btn-danger">Kembali</a>
                                        </div>                                      
                                    </div>
                                </div>                              
                                <div class="col-sm-4 col-sm-offset-2">
        ...
        <script type="text/javascript">
            ...
            $(function() {
                $("#kolok").on("change", function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url(); ?>index.php/hist/jabatan_hist/getKojab",
                        type: "post",
