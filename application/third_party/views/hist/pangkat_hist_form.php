<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>pangkat_history_form</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
	            	...
	            	<form id="defaultForm2" name="defaultForm2" method="post" class="form-horizontal">
	            			...
	            			<div class="form-group">
                            	...
                            	<div class="input-group col-sm-4">
                                    ...
                                    <select class="form-control select2_pejtt" name="pejtt" id="pejtt" tabindex="2" placeholder="PEJTT">
                                        <option></option>
                                        <?php echo $listPejtt; ?> 
                                    </select>
                            	</div>
	            			...
	            			<div class="form-group">                               
                                <div class="col-sm-4 col-sm-offset-2">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a href="<?php echo base_url(); ?>index.php/hist/pangkat_hist" class="btn btn-danger">Kembali</a>
                                        </div>                                      
                                    </div>
                                </div>                              
                                <div class="col-sm-4 col-sm-offset-2">
