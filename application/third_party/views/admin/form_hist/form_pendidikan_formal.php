    ...
    <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group pickerpicker">
                        <label class="col-sm-4 control-label"><font color="blue">Jenis Pendidikan</font></label>
                        <div class="input-group col-sm-7">
                    ...
                    <div class="form-group pickerpicker">
                        <label class="col-sm-4 control-label"><font color="blue">Kode Pendidikan</font></label>
                        <div class="input-group col-sm-7">
                    ...
                    <?php if($action == 'update'){ ?>   
                        <?php if($infoPendidikan->KODIK >=4000){ ?>
                        <div class="form-group pickerpicker" id="data_univer">
                            <label class="col-sm-4 control-label">Universitas</label>
                            <div class="input-group col-sm-7">
                                <select class="form-control chosen-univer" name="univer" id="univer" tabindex="2" data-placeholder="Pilih Nama Universitas">
                                    <option value=""></option>
                                    <?php echo $listUniver; ?> 
                                </select>
                            </div>
                        ...
                        <label class="col-sm-4 control-label">Universitas</label>
                        <div class="input-group col-sm-7">
                            <select class="form-control chosen-univer" name="univer" id="univer" readonly="readonly" tabindex="2" data-placeholder="Pilih Nama Universitas">
                                <option value=""></option>
                                <?php echo $listUniver; ?> 
                    ...
                    <?php if($action == 'update'){ ?>   
                        ...
                        <div class="form-group pickerpicker" id="data_nasek" style="display:none">
                            ...
                            <div class="input-group col-sm-7">
                                <input type="text" id="nasek" name="nasek" maxlength="30" placeholder="Nama Sekolah" value="<?php echo isset($infoPendidikan->NASEK) ? $infoPendidikan->NASEK : ""; ?>" class="form-control">
                            </div>
                        </div>
                        <?php } else{ ?>
...
function save()
{
    ...
    {
        url = "<?php echo site_url('home/ajax_update_pend_formal')?>";
    }
    else
    {
        url = "<?php echo site_url('home/ajax_add_pend_formal')?>";
    }
