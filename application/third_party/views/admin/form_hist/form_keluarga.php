            ...
            <div class="hr-line-dashed"></div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group pickerpicker">
                          ...
                          <div class="input-group col-sm-7">
                             <input type="text" id="nik" maxlength="16" name="nik" placeholder="NIK" class="form-control" value="<?php echo isset($infoKeluarga->NIK) ? $infoKeluarga->NIK : ""; ?>" data-mask="999999999999999999">
                          </div>
                    </div>
