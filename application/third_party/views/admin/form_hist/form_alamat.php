            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group pickerpicker" id="data_1">
                        <label class="col-sm-5 control-label">Tgl. Mulai Tinggal</label>
                        <?php if($action == 'update'){ ?>
                            <div class="input-group col-sm-3 date">
                                <span class="input-group-addon" style="display: none"><i class="fa fa-calendar"></i></span><input type="text" id="tgmulai" name="tgmulai" placeholder="Tg Mulai" value="<?php echo isset($infoAlamat->TGMULAI) ? date('d-m-Y', strtotime($infoAlamat->TGMULAI)) : '' ?>" class="form-control" readonly>
                            </div>
                        <?php } else { ?>
                            <div class="input-group col-sm-3 date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="tgmulai"  name="tgmulai" placeholder="Tg Mulai" value="<?php echo isset($infoAlamat->TGMULAI) ? date('d-m-Y', strtotime($infoAlamat->TGMULAI)) : '' ?>" class="form-control">
                            </div>
                        <?php } ?>
                    </div>
                ...
                <div class="col-sm-6">                    
                    ...
                    <div class="form-group pickerpicker">
                        ...
                        <div class="input-group col-sm-8">
                            <textarea class="form-control" name="alamat" id="alamat" maxlength="100" placeholder="Alamat Tempat Tinggal"><?php echo isset($infoAlamat->ALAMAT) ? $infoAlamat->ALAMAT : ''; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group pickerpicker">
                      ...
                      <div class="input-group col-sm-8">                               
                         <select class="form-control chosen-wilayah" name="kowil" id="kowil" tabindex="2" data-placeholder="Pilih Kabupaten/Kota...">
                            <option value=""></option>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group pickerpicker" id="div_wil_ktp">
                      <label class="col-sm-4 control-label">Kota/Kabupaten</label>
                      <div class="input-group col-sm-8">                               
                         <select class="form-control chosen-wilayah-ktp" name="kowil_ktp" id="kowil_ktp" tabindex="2" data-placeholder="Pilih Kabupaten/Kota...">
                            <option value=""></option>
