...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">      
    <div class="modal-header">
    	...
    	<h4 class="modal-title" id="myModalLabel">Form Referensi Jenis Seminar</h4>
    </div>
    <div class="modal-body">
            ...
            <div class="row">
                <!-- START SIDE 1 -->
                <div class="col-md-12">
                <input type="hidden" value="ref_kdsemi" name="destination" id="destination">
        ...
        $('#defaultForm2').bootstrapValidator({
            ...
            fields: {            
                keterangan: {
                    validators: {
                        notEmpty: {
                            message: 'Nama Jenis Seminar tidak boleh kosong'
                        }
                    }
                }
            }
