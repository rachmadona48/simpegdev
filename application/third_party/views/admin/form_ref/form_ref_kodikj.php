...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">      
    <div class="modal-header">
    	...
    	<h4 class="modal-title" id="myModalLabel">Form Referensi Tingkat Pendidikan Penjenjangan</h4>
    </div>
    <div class="modal-body">
            ...
            <div class="row">
                <!-- START SIDE 1 -->
                <div class="col-md-12">
                <input type="hidden" value="ref_kodikj" name="destination" id="destination">
                <input type="hidden" value="tambah" name="action" id="action">
                <input type="hidden" value="" name="key" id="key">    
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Nama</label>
                        <div class="col-lg-8">
                            <input type="text" id="keterangan" name="keterangan" maxlength="30" placeholder="Nama Tingkat Pendidikan Penjenjangan" value="<?php echo isset($isian->KETERANGAN) ? $isian->KETERANGAN : ""; ?>" class="form-control">
                        </div>
                    </div>
        ...
        $('#defaultForm2').bootstrapValidator({
            ...
            fields: {            
                keterangan: {
                    validators: {
                        notEmpty: {
                            message: 'Nama Tingkat Pendidikan Penjenjangan tidak boleh kosong'
                        }
                    }
                }
            }
