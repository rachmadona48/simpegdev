...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">      
    <div class="modal-header">
    	...
    	<h4 class="modal-title" id="myModalLabel">Form Referensi Peran Penulisan</h4>
    </div>
    <div class="modal-body">
            ...
            <div class="row">
                <!-- START SIDE 1 -->
                <div class="col-md-12">
                <input type="hidden" value="ref_peran" name="destination" id="destination">
                <input type="hidden" value="tambah" name="action" id="action">
                <input type="hidden" value="" name="key" id="key">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Kode</label>
                        <div class="col-lg-8">
                            <input type="text" id="kdperan" name="kdperan" maxlength="2" placeholder="Kode" value="<?php echo isset($isian->KDPERAN) ? $isian->KDPERAN : ""; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
