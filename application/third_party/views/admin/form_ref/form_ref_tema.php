...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">      
    <div class="modal-header">
    	...
    	<h4 class="modal-title" id="myModalLabel">Form Referensi Tema</h4>
    </div>
    <div class="modal-body">
            ...
            <div class="row">
                <!-- START SIDE 1 -->
                <div class="col-md-12">
                <input type="hidden" value="ref_tema" name="destination" id="destination">
                <input type="hidden" value="tambah" name="action" id="action">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Kode</label>
                        <div class="col-lg-8">
                            <input type="text" id="kdtema" name="kdtema" maxlength="2" placeholder="Kode" value="<?php echo isset($isian->KDTEMA) ? $isian->KDTEMA : ""; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Nama Tema</label>
                        <div class="col-lg-8">
                            <input type="text" id="natema" name="natema" maxlength="30" placeholder="Keterangan" value="<?php echo isset($isian->NATEMA) ? $isian->NATEMA : ""; ?>" class="form-control">
                        </div>
                    </div>
        ...
        $('#defaultForm2').bootstrapValidator({
            ...
            fields: {            
                kdtema: {
                    ...
                    validators: {
                        notEmpty: {
                            message: 'Nama Tema tidak boleh kosong'
                        }
                    }
                }
            }
