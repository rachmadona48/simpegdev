...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">      
    <div class="modal-header">
    	...
    	<h4 class="modal-title" id="myModalLabel">Form Referensi Pangkat</h4>
    </div>
    <div class="modal-body">
            ...
            <div class="row">
                <!-- START SIDE 1 -->
                <div class="col-md-12">
                <input type="hidden" value="ref_pangkat" name="destination" id="destination">
                ...
                <input type="hidden" value="" name="key" id="key">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="kopang" name="kopang" minlength="3" maxlength="3" onkeypress="return numbersonly1(this, event)" placeholder="Kopang" value="<?php echo isset($isian->KOPANG) ? $isian->KOPANG : ""; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Golongan</label>
                        <div class="col-lg-8">
                            <input type="text" id="gol" name="gol" maxlength="10" placeholder="Golongan" value="<?php echo isset($isian->GOL) ? $isian->GOL : ""; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Nama Pangkat</label>
                        <div class="col-lg-8">
                            <input type="text" id="napang" name="napang" maxlength="20" placeholder="Nama Pangkat" value="<?php echo isset($isian->NAPANG) ? $isian->NAPANG : ""; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Kopang PNS</label>
                        <div class="col-lg-8">
                            <input type="text" id="kopang_pns" name="kopang_pns"  maxlength="3" placeholder="KOPANG PNS" value="<?php echo isset($isian->KOPANG_PNS) ? $isian->KOPANG_PNS : ""; ?>" class="form-control">
                        </div>
                    </div>
        ...
        $('#defaultForm2').bootstrapValidator({
            ...
            fields: {
                kopang: {                
                    validators: {
                        notEmpty: {
                            message: 'Kode pangkat tidak boleh kosong'
                        }
                    }
                },            
                napang: {                
