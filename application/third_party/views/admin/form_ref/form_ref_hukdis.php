...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">      
    <div class="modal-header">
    	...
    	<h4 class="modal-title" id="myModalLabel">Form Referensi Jenis Hukuman Disiplin</h4>
    </div>
    <div class="modal-body">
            ...
            <div class="row">
                <!-- START SIDE 1 -->
                <div class="col-md-12">
                <input type="hidden" value="ref_hukdis" name="destination" id="destination">
                <input type="hidden" value="tambah" name="action" id="action">
                <input type="hidden" value="" name="key" id="key">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Keterangan</label>
                        <div class="col-lg-8">
                            <input type="text" style="text-transform:uppercase" id="keterangan" name="keterangan" placeholder="Keterangan" maxlength="50" value="<?php echo isset($isian->KETERANGAN) ? $isian->KETERANGAN : ""; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>      

                    <div class="form-group">
                        <label class="col-sm-4 control-label">Keterangan Lengkap</label>
                        <div class="col-lg-8">
                            <input type="text" style="text-transform:uppercase" id="ket_lengkap" name="ket_lengkap" placeholder="Keterangan Lengkap" maxlength="50" value="<?php echo isset($isian->KET_LENGKAP) ? $isian->KET_LENGKAP : ""; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>   
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" style="text-transform:uppercase" id="jenhuk" name="jenhuk" placeholder="(RINGAN,SEDANG,BERAT)" maxlength="50" value="<?php echo isset($isian->JENIS_HUKUMAN) ? $isian->JENIS_HUKUMAN : ""; ?>" class="form-control">
                        </div>
                    </div>              
