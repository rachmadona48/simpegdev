...
<form id="defaultForm2" name="defaultForm2" data-backdrop="static" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">
    ...
    <div class="modal-body">
            ...
            <div class="row">
                <!-- START SIDE 1 -->
                <div class="col-md-12">
                <input type="hidden" value="ref_gapok_tbl" name="destination" id="destination">
                <input type="hidden" value="tambah" name="action" id="action">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">Tahun Referensi</label>
                        <div class="col-lg-7">
                            <input type="text" id="tahun_ref" name="tahun_ref" placeholder="Tahun Referensi (numbers only)" maxlength="4" onkeypress="return numbersonly1(this, event)" value="<?php echo isset($isian->TAHUN) ? $isian->TAHUN : ""; ?>" class="form-control">
                        </div>
                    </div>
