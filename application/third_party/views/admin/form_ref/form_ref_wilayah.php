...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">      
    <div class="modal-header">
    	...
    	<h4 class="modal-title" id="myModalLabel">Form Referensi Wilayah</h4>
    </div>
    <div class="modal-body">
            ...
            <div class="row">
                <!-- START SIDE 1 -->
                <div class="col-md-12">
                <input type="hidden" value="ref_wilayah" name="destination" id="destination">
                ...
                <input type="hidden" value="" name="key" id="key">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="nawil" name="nawil" maxlength="15" placeholder="Nama Wilayah" value="<?php echo isset($isian->NAWIL) ? $isian->NAWIL : ""; ?>" class="form-control">
                        </div>
                    </div>
