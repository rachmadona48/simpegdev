...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Form Referensi Hubungan Keluarga</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="row">
            <!-- START SIDE 1 -->
            <div class="col-md-12">
                <input type="hidden" value="ref_hubkel" name="destination" id="destination">
                <input type="hidden" value="tambah" name="action" id="action">
                <input type="hidden" value="" name="key" id="key">
                <div class="form-group ">
                    <label class="col-sm-4 control-label">Kode Hubungan Keluarga</label>
                    <div class="col-lg-8">
                        <input type="text" id="hubkel" name="hubkel" minlength="2" maxlength="2" onkeypress="return numbersonly1(this, event)" placeholder="Kode Hubungan Keluarga" value="<?php echo isset($isian->NAHUBKEL) ? $isian->NAHUBKEL : ""; ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">Nama Hubungan Keluarga</label>
                    <div class="col-lg-8">
                        <input type="text" id="nahubkel" name="nahubkel" maxlength="25" style="text-transform:uppercase" placeholder="Nama Hubungan Keluarga" value="<?php echo isset($isian->NAHUBKEL) ? $isian->NAHUBKEL : ""; ?>" class="form-control">
                    </div>
                </div>
        ...
        $('#defaultForm2').bootstrapValidator({
            ...
            fields: {
                hubkel: {
                    validators: {
                        notEmpty: {
                            message: 'Kode Hubungan Keluarga tidak boleh kosong'
                        }
                    }
                },
                nahubkel: {
