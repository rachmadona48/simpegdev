...
<table>
  <tr>
    ...
    <td style="width:75%">
      <ol type="a">
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan hasil penelitian administrasi dan Keputusan Gubernur Nomor .......... tentang ............., dan untuk kepentingan dinas perlu membebaskan sementara Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.' dari jabatan fungsional '.$najabl.' dan '.$nm_tingkat.' PADA '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
        <li style="text-align:justify; line-height:150%">bahwa sesuai ketentuan Pasal ….. Peraturan Menteri Pendayagunaan Aparatur Negara Nomor ………… tentang Jabatan Fungsional '.$najabl.' dan angka kreditnya, dinyatakan bahwa '.$najabl.' dibebaskan sementara dari jabatannya apabila ditugaskan secara penuh di luar jabatan '.$najabl.';</li>
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a dan huruf b, perlu menetapkan Keputusan Gubernur tentang Pembebasan Sementara Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.' dari Jabatan Fungsional '.$najabl.' dan '.$nm_tingkat.' PADA '.$skpd.' pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
      </ol>
    </td>
  </tr>
  <tr>
