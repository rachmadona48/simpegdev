<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
        <h2>Jenis Peran Penulis</h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Ref</a>
            </li>
            <li class="active">
                <strong>Jenis Peran Penulis</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
		...
		<script type="text/javascript" language="javascript" >
     	 ...
     	 $(document).ready(function() {	
				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"ajax":{
						url :"<?php echo base_url(); ?>index.php/ref/ref_kdperant/data", // json datasource
