...
class Pdf_isi_perbal extends TCPDF
{
    function __construct()
    {
        parent::__construct('P','mm','F4',true,'UTF-8',false,false);
    ...
    public function Header() {
        ...
        $this->Image($image_file, 85, 10, 45, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
