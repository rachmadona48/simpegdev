...
class Pdf_gaji extends TCPDF
{
    ...
    public function Header() {
        ...
        $this->Cell(0, 5, 'PEMERINTAH PROPINSI DKI JAKARTA', 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $this->Ln();
        $this->SetFont('helvetica', 'B', 10);
        $this->Cell(30, 5, 'BADAN KEPEGAWAIAN DAERAH', 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $this->Ln();
