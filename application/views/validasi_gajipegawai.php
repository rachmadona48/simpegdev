                        ...
                        <h3 class="no-margins">
                          ...
                          <div class="col-md-12">
                            <address style="font-size:11px;">
                              ...
                              <span>
                                 <p>NIP : &nbsp; <i><?php echo $nip18; ?></i></p>
                              </span>

                              <span>
                                 <p>LOKASI GAJI : &nbsp; <i><?php echo $naklogad; ?></i></p>
                              </span>

                              <span>
                                 <p>Bulan Tahun Gajian : <i>&nbsp; <?php echo $bulan.' '.$tahun; ?></i></p>
                              </span>

                              <span>
                              <p>Gaji Bersih : <i>&nbsp; <?php echo $this->format_uang->rp_format($njumbergaji); ?></i></p>
