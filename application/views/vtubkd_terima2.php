        ...
        <div class="col-md-12">
            <div class="ibox animated fadeInLeft">
                <div class="ibox-title navy-bg">
                    <h5>Laporan Permohonan Pegawai Yang Diterima</h5>
                        ...
                        <div class="col-md-12" id="tbl_list_pegawai">
                                ...
                                <table id="tbl_list_dt" class="table table-striped table-bordered table-hover dataTables-example" >
                                    <thead>
                                        <tr>
                                            <th width="5%">No</th>
                                            <th width="15%">No Surat Permohonan</th>
                                            <th width="12%">Tgl Surat Permohonan</th>
...
//            $('#t2').hide();
            ...
            var t2= $('#t2').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: '<?php echo site_url("tubkd/getDataTrxDtl"); ?>',
                    type: "post",
                    data: function ( d ) {
       ...
       function setT2(id_trx_hdr,no_surat){
        ...
        function get_all_pegawai_terima(){
            ...
            var dtbl= $('#tbl_list_dt').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url: '<?php echo base_url("index.php/tubkd/get_data_table_terima2"); ?>/',
                    type: "post",
                    data: {
