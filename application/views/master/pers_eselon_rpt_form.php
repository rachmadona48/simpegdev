        	...
        	<div class="ibox float-e-margins">
	            ...
	            <div class="ibox-content">
	            	<form id="defaultForm2" name="defaultForm2" method="post" class="form-horizontal">
                            <input type="hidden" id="eselonOld" name="eselonOld" placeholder="Eselon" value="<?php echo isset($eselon) ? $eselon : ""; ?>" class="form-control">
                            ...
                            <div class="form-group">                               
                                <div class="col-sm-4 col-sm-offset-2">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a href="<?php echo base_url(); ?>index.php/master/eselon" class="btn btn-danger">Kembali</a>
                                        </div>                                      
                                    </div>
                                </div>                              
                                <div class="col-sm-4 col-sm-offset-2">
