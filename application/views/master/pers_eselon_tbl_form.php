        	...
        	<div class="ibox float-e-margins">
	            ...
	            <div class="ibox-content">
	            	<form id="defaultForm2" name="defaultForm2" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Neselon</label>
                                <div class="col-sm-10">
                                    <input type="text" id="neselon" name="neselon" placeholder="Neselon" value="<?php echo isset($neselon) ? $neselon : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>                                                                                 
