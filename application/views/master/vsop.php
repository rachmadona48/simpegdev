	...
	<div class="modal-dialog">
		<div class="modal-content animated fadeIn">
			<div class="modal-header">
				...
				<h4 class="modal-title">Form SOP</h4>
				<small></small>
			</div>
			<form id="frm1" name="frm1" role="form">
				<input type="hidden" id="id_sop" name="id_sop">
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
								<label class="control-label">Nama SOP</label>
								<div>
									<textarea id="nm_sop" name="nm_sop" rows="3" class="form-control"></textarea>
								</div>
					</div>
				</div>
			</div>
...
<div class="modal inmodal" id="modalDtl" tabindex="-1" role="dialog"  aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content animated fadeIn">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title">Form Detail SOP</h4>
				<small></small>
			</div>
			<form id="frm2" name="frm2" role="form">
				<input type="hidden" id="id_sop2" name="id_sop2">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-sm-12">
							<label class="control-label">Deskripsi SOP</label>
							<div>
								<textarea id="deskripsi_sop" name="deskripsi_sop" rows="3" class="form-control"></textarea>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
							...
							<div>
								<select id="pelaksana" name="pelaksana" rows="3" class="form-control chosen-select">
									<?php echo $optPelaksana?>
								</select>
							</div>
						</div>
					</div>
...
//            $('#t2').hide();
	...
	$("#frm1").ajaxForm({
		...
		/*START CHOSEN*/
                var config = {
                  '.chosen-select'           : {search_contains:true,no_results_text:'Oops, Data Tidak Ditemukan',width: "100%"}
                }
...
//					swal("Kerja Bagus!", data[0], "success");
	...
	function setT2(id_sop,nm_sop){
		$("#id_sop2").val(id_sop);

		$("#nm_sop_lbl").text(' Nama SOP: '+nm_sop);
		$('#btn_tbh2').show();
		$('#t2').show();
		var t2 = $('#t2').DataTable();
		t2.ajax.reload();
