	            ...
	            <div class="ibox-content">
	            	<form id="defaultForm2" name="defaultForm2" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="gaji" name="gaji" placeholder="Gaji" value="<?php echo isset($gaji) ? $gaji : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="tunjangan" name="tunjangan" placeholder="Tunjangan" value="<?php echo isset($tunjangan) ? $tunjangan : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Gajikotor</label>
                                <div class="col-sm-10">
                                    <input type="text" id="gajikotor" name="gajikotor" placeholder="Gajikotor" value="<?php echo isset($gajikotor) ? $gajikotor : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Gajibersih</label>
                                <div class="col-sm-10">
                                    <input type="text" id="gajibersih" name="gajibersih" placeholder="Gajibersih" value="<?php echo isset($gajibersih) ? $gajibersih : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="tgllahir" name="tgllahir" placeholder="Tgllahir" value="<?php echo isset($tgllahir) ? $tgllahir : ""; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">                               
                                <div class="col-sm-4 col-sm-offset-2">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a href="<?php echo base_url(); ?>index.php/master/gajiptt" class="btn btn-danger">Kembali</a>
                                        </div>                                      
                                    </div>
                                </div>                              
                                <div class="col-sm-4 col-sm-offset-2">
