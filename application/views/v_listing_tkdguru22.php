                        ...
                        <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control chosen-jenis" name="jenis" id="jenis" data-placeholder="Cari Berdasarkan...">
                                        ...
                                        <option value="1">Listing TKD Guru Disdik 22</option>
                                        <option value="2">Listing TKD Guru Gab 22</option>
                                        <option value="3">Listing TKD Guru SPMU 22</option>
                                        <option value="4">Rekap TKD Guru Disdik 22</option>
                                        <option value="5">Rekap TKD Guru Gab 22</option>
                                        <option value="6">Rekap TKD Guru SPMU 22</option>
                            ...
                            <br/><br/>  <div class="col-md-12">
                                ...
                                <div id="paramval1" style="display: none">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control chosen-thbl" name="thbl1" id="thbl1" tabindex="2" data-placeholder="Pilih inputan..." >
                                            <option value=""></option>
                                                <?php echo $thbltkdguru22; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-3">
                                        <a onclick="cetaklistingtkdguru22(); return false;" id="btnPdf" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>   
                                <!-- END TKD Guru Disdik 22-->
                                ...
                                <div id="paramval2" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                         <a onclick="cetaklistingtkdgurugab22(); return false;" id="btnPdf" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>     
                                <!-- END TKD Guru Gab 22-->
                                ...
                                <div id="paramval3" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                        <a onclick="cetaklistingtkdguruspmu22(); return false;" id="btnPdf3" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>     
                                <!-- END TKD Guru SPMU 22-->

                                <!--Rekap TKD Guru Disdik 22-->
                                <div id="paramval4" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                         <a onclick="cetakrekaptkdgurudisdik22(); return false;" id="btnPdf4" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>     
                                <!-- END TKD Guru Gab 22-->
                                ...
                                <div id="paramval5" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                        <a onclick="cetakrekaptkdgurugab22(); return false;" id="btnPdf5" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>     
                                <!-- END Rekap TKD Guru Gab 22-->
                                ...
                                <div id="paramval6" style="display: none">
                                    ...
                                    <div class="col-md-3">
                                        <a onclick="cetakrekaptkdguruspmu22(); return false;" id="btnPdf6" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Cetak</a>
                                    </div>
                                </div>     
                                <!-- END TKD Guru SPMU 22-->
                        </div>
    ...
    <!-- END WELLCOME -->
        ...
        $(document).ready(function(){
            ...
            function cetaklistingtkdguru22()
            {
                var thblleng= $('#thbl1').val().length;
                var thbl= $('#thbl1').val();
                if( thblleng >0)
                {
                    window.open('<?=site_url('listing')?>/cetaklistingtkdguru22/'+thbl);
                }
                else
                {
            ...
            function cetaklistingtkdgurugab22()
            {
                var thblleng= $('#thbl2').val().length;
                var thbl= $('#thbl2').val();
                if( thblleng >0)
                {
                    window.open('<?=site_url('listing')?>/cetaklistingtkdgurugab22/'+thbl);
                }
                else
                {
                    alert('THBL Harap Diisi');
            ...
            function cetaklistingtkdguruspmu22()
            {
                ...
                {
                    window.open('<?=site_url('listing')?>/cetaklistingtkdguruspmu22/'+thbl+'/'+skpd);
                }
            }

            function cetakrekaptkdgurudisdik22()
            {
                var thblleng= $('#thbl4').val().length;
                var thbl= $('#thbl4').val();
                if( thblleng >0)
                {
                    window.open('<?=site_url('listing')?>/cetakrekaptkdgurudisdik22/'+thbl);
                }
                else
                {
                    alert('THBL Harap Diisi');
            ...
            function cetakrekaptkdgurugab22()
            {
                var thblleng= $('#thbl5').val().length;
                var thbl= $('#thbl5').val();
                if( thblleng >0)
                {
                    window.open('<?=site_url('listing')?>/cetakrekaptkdgurugab22/'+thbl);
                }
                else
                {
                    alert('THBL Harap Diisi');
           ...
           function cetakrekaptkdguruspmu22()
            {
                ...
                {
                    window.open('<?=site_url('listing')?>/cetakrekaptkdguruspmu22/'+thbl+'/'+skpd);
                }
            }
