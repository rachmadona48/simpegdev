...
<table>
  <tr>
    ...
    <td style="width:75%">
      <ol type="a">
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan hasil penelitian administrasi dan Keputusan Gubernur Nomor '.$dasar_hukum3[0].' Tentang..... (Pembebasan Sementara), Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.', telah diberikan waktu 1 (satu) tahun untuk mengumpulkan Angka Kredit untuk kenaikan pangkat dan atau jenjang jabatan fungsional '.$najabl.', namun tidak dapat memperoleh angka kredit yang dipersyaratkan dan untuk kepentingan dinas perlu memberhentikan dari jabatan fungsional '.$najabl.' pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
