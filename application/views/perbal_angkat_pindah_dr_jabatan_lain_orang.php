...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PENGANGKATAN PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' PANGKAT/GOLONGAN RUANG '.$napang.'/'.$gol.' DALAM JABATAN FUNGSIONAL '.$najabl.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA.</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Mengangkat Pegawai Negeri Sipil dalam jabatan fungsional '.$najabl.' dan '.$nm_tingkat.', dengan angka kredit sebesar '.$angka_kredit.' ('.$angka_kredit_words.').<br/><br/>
