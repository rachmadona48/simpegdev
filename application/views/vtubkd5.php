...
//                destroy: true,
                ...
                "serverSide": true,
                "ajax": {
                    url: '<?php echo base_url("index.php/tubkd/get_data_table2"); ?>/9',
                    type: "post",
                     data: {
        ...
        function confirmKirimData(no_terima,id_trx_hdrp,tgl_terima,notifikasi,ID_TRX){
                console.log(no_terima, id_trx_hdrp, tgl_terima, notifikasi, ID_TRX)
                /*START SWEETALERT*/                
                    swal({
                        ...
                        if (isConfirm) {
                            ...
                            simpanData(no_terima,id_trx_hdrp,tgl_terima,notifikasi,ID_TRX); 
           ...
           function simpanData(no_terima,no_bu,id_trx_hdrp,tgl_terima,notifikasi,ID_TRX){
                ...
                $.ajax({
                    url: "<?php echo site_url('tubkd/simpan_data5')?>",
                    type: "post",
                    data: {no_terima:a, id_trx_hdrp:b,tgl_terima:d,notifikasi:e,ID_TRX:f},
                    dataType: 'json',
                    beforeSend: function() {
