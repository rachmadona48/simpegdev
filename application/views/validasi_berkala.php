                        ...
                        <h3 class="no-margins">
                          ...
                          <div class="col-md-12">
                            <address style="font-size:11px;">
                              <span>
                                 <p>NRK : &nbsp; <i><?php echo $nrk; ?></i></p>
                              </span>

                              <span>
                                 <p>Nama : &nbsp; <i><?php echo $nama; ?></i></p>
                              </span>

                              <span>
                                 <p>Bulan Tahun : &nbsp; <i><?php echo $thbl; ?></i></p>
                              </span>

                              <span>
                                 <p>Golongan : &nbsp; <i><?php echo $gol; ?></i></p>
                              </span>

                             

                              <span>
                                 <p>Masa Kerja : <i>&nbsp; <?php echo $masker; ?> &nbsp; tahun</i></p>
                              </span>

                              <span>
                              <p>Gaji baru : <i>&nbsp; <?php echo $this->format_uang->rp_format($gjbaru); ?></i></p>
