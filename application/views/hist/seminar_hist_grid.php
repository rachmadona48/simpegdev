	...
	<div class="row">
        <div class="col-lg-12">
            <div class="contact-box">
            	<div>
					<a href="<?php echo base_url(); ?>index.php/hist/seminar_hist/doadd/" class="btn btn-success pull-right">
						<i class="glyphicon glyphicon-plus"></i>Tambah Seminar History
					</a>
				</div>
            	<div>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {			
				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"ajax":{
						url :"<?php echo base_url(); ?>index.php/hist/seminar_hist/data", // json datasource
			...
			function hapusData(id1,id2, action){
				...
				var formData = {nrk:id1,tgmulai:id2};
