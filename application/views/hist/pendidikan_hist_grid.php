	...
	<div class="row">
        <div class="col-lg-12">
            <div class="contact-box">
            	<div>
					<a href="<?php echo base_url(); ?>index.php/hist/pendidikan_hist/doadd/" class="btn btn-success pull-right">
						<i class="glyphicon glyphicon-plus"></i> Tambah Pendidikan History
					</a>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {			
				...
				/*var dataTable = $('#employee-grid').DataTable( {
					...
					"ajax":{
						url :"<?php echo base_url(); ?>index.php/hist/pendidikan_hist/data", // json datasource
				...
				function cari()
				{
					...
					var dataTable = $('#employee-grid').DataTable( {
						...
						"ajax":{
							url :"<?php echo base_url(); ?>index.php/hist/pendidikan_hist/data/"+cari, // json datasource
							type: "post",  // method  , by default get
							error: function(){  // error handling
								$(".employee-grid-error").html("");
								$("#employee-grid").append('<tbody class="employee-grid-error"><tr><th>No data found in the server</th></tr></tbody>');
			...
			function hapusData(id1,id2,id3, action){
				...
				var formData = {nrk:id1,jendik:id2,kodik:id3};
