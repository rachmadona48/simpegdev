...
$this->pdf_perbal->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE,'', PDF_HEADER_STRING);

// set header and footer fonts
$this->pdf_perbal->setHeaderFont(Array(PDF_FONT_NAME_MAIN, '', PDF_FONT_SIZE_MAIN));
$this->pdf_perbal->setFooterFont(Array(PDF_FONT_NAME_DATA, '', PDF_FONT_SIZE_DATA));

// remove default header/footer
//$this->pdf_perbal->setPrintHeader(false);
//$this->pdf_perbal->setPrintFooter(false);

// set default monospaced font
$this->pdf_perbal->SetDefaultMonospacedFont(PDF_FONT_MONOSPACED);

// set margins
$this->pdf_perbal->SetMargins(PDF_MARGIN_LEFT, 15, PDF_MARGIN_RIGHT);
//$this->pdf->SetMargins(15, 15, 15);
$this->pdf_perbal->SetHeaderMargin(PDF_MARGIN_HEADER);
$this->pdf_perbal->SetFooterMargin(PDF_MARGIN_FOOTER);

// set auto page breaks
$this->pdf_perbal->SetAutoPageBreak(TRUE, PDF_MARGIN_BOTTOM);

// set image scale factor
$this->pdf_perbal->setImageScale(PDF_IMAGE_SCALE_RATIO);

// set some language-dependent strings (optional)
if (@file_exists(dirname(__FILE__).'/lang/eng.php')) {
require_once(dirname(__FILE__).'/lang/eng.php');
$pdf_perbal->setLanguageArray($l);
}

// ---------------------------------------------------------

// set font
$this->pdf_perbal->SetFont('helvetica', 'B', 20);

// add a page
$this->pdf_perbal->AddPage('P');

$this->pdf_perbal->Write(0, '', '', 0, 'L', true, 0, false, false, 0);

$this->pdf_perbal->SetFont('helvetica', '', 10);
*/
$html = '
...
<table>
  <tr>
    ...
    <td style="width:75%">
      <ol type="a">
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan Keputusan Kepala Kantor Regional V Badan Kepegawaian Negara Nomor ............ tanggal ........., Pegawai Negeri Sipil atas nama '.$nama.', NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.', telah memenuhi syarat untuk diangkat kembali dalam Jabatan Fungsional '.$najabl.' pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PENGANGKATAN KEMBALI PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' PANGKAT/GOLONGAN RUANG '.$napang.'/'.$gol.' DALAM JABATAN FUNGSIONAL '.$najabl.' dan '.$nm_tingkat.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA.</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Mengangkat Pegawai Negeri Sipil dalam jabatan fungsional ('.$najabl.'/'.$nm_tingkat.'), dengan angka kredit sebesar  '.$angka_kredit.' ('.$angka_kredit_words.').<br/><br/>
  ...
  <tr>
    <td>KEDUA</td>
    <td>:</td>
    <td style="line-height:150%">Kepada Pegawai Negeri Sipil sebagaimana dimaksud pada diktum KESATU diberikan tunjangan jabatan fungsional '.$najabl.' dan '.$nm_tingkat.' sesuai dengan ketentuan peraturan perundang-undangan.</td>
  </tr>
  <tr>
    <td>KETIGA</td>
    <td>:</td>
...
';
echo $html;
/*$this->pdf_perbal->writeHTML($html, true, false, false, false, '');
ob_clean();

$this->pdf_perbal->Output('perbal_naik_jenjang_jabfung_kolektif.pdf', 'I');*/