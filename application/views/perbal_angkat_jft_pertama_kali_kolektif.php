...
*/
$html = '
<p style="text-align:justify line-height:150%; width:50%">PENGANGKATAN PERTAMA KALI PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' DAN KAWAN-KAWAN SEBANYAK '.$jumlah_orang.' ORANG DALAM JABATAN FUNGSIONAL '.$najabl.' dan '.$nm_tingkat.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA<br/></p>
...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PENGANGKATAN PERTAMA KALI PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' DAN KAWAN-KAWAN SEBANYAK '.$jumlah_orang.' DALAM JABATAN FUNGSIONAL '.$najabl.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA.</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
    <td style="line-height:150%">Mengangkat Pertama kali Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' dan kawan-kawan sebanyak '.$jumlah_orang.' dalam jabatan fungsional '.$najabl.' pada '.$skpd.', dengan angka kredit sebagaimana terlampir dalam Keputusan Gubernur ini.</td>
  </tr>
  <tr>
    <td>KEDUA</td>
    <td>:</td>
