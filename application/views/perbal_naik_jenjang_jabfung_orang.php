...
/*$html = '
<br/><br/><br/><br/><br/><br/>
<p style="text-align:center">KEPUTUSAN GUBERNUR PROVINSI DAERAH KHUSUS<br/>IBUKOTA JAKARTA<br/><br/>NOMOR<br/><br/>TENTANG<br/></p>
<p style="text-align:justify line-height:150%; width:50%">PENGANGKATAN PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' PANGKAT/GOLONGAN RUANG '.$napang.'/'.$gol.' DALAM JABATAN FUNGSIONAL '.$najabl.' dan '.$nm_tingkat.' PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA<br/></p>';*/
$html = '
...
<table>
  <tr>
    ...
    <td style="width:75%">
      <ol type="a">
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan hasil penelitian administrasi, Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.', telah memenuhi syarat untuk diangkat dalam pangkat dan atau jenjang jabatan fungsional '.$najabl.' setingkat lebih tinggi karena telah memperoleh angka kredit yang dipersyaratkan pada '.$skpd.';</li>
        ...
        <li style="text-align:justify; line-height:150%">bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a dan huruf b, perlu menetapkan Keputusan Gubernur tentang Pengangkatan Pegawai Negeri Sipil atas nama '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' Pangkat/Golongan Ruang '.$napang.'/'.$gol.' dalam Jabatan Fungsional ('.$najabl.'/'.$nm_tingkat.') pada '.$skpd.' Provinsi Daerah Khusus Ibukota Jakarta;</li>
      </ol>
    </td>
  </tr>
  <tr>
...
<table>
  <tr>
    ...
    <td style="width:3%;text-align:center">:</td>
    <td style="width:75%;line-height:150%">KEPUTUSAN GUBERNUR TENTANG PENGANGKATAN PEGAWAI NEGERI SIPIL ATAS NAMA '.$nama.' NIP/NRK '.$nip.'/'.$nrk.' PANGKAT/GOLONGAN RUANG '.$napang.'/'.$gol.' DALAM JABATAN FUNGSIONAL ('.$najabl.'/'.$nm_tingkat.') PADA '.$skpd.' PROVINSI DAERAH KHUSUS IBUKOTA JAKARTA.</td>
  </tr>
  <tr>
    <td>KESATU</td>
    <td>:</td>
...
$this->pdf_isi_perbal->Output('perbal_naik_jenjang_jabfung_perorang.pdf', 'I');*/