...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Dashboard Biro Hukum</h2>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo site_url().'birohukum'?>"><font color="blue"><u>Home</u></font></a>
            </li>
            <li class="active">
                <strong>Index</strong>
            </li>
        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins text-center">
                ...
                <div class="ibox-content">
                    ...
                    <a href="<?php echo base_url('birohukum/permohonan') ?>" class="btn btn-warning btn-lg btn-block"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>                    
                </div>
            </div>
        </div>
        <div class="col-lg-4">
