                                ...
                                <form class="form-horizontal" id="defaultForm" method="post">
                                    <div class="form-group">
                                        <div class="col-md-12" id="tbl_list_permohonan">
                                            <table id="tbl_list_prm" class="table table-striped table-bordered table-hover dataTables-example" >
                                                 <thead>
                                                    <tr>
                                                        <th width="5%">No</th>
...
<!--                                                </div>-->
<!--                                                <div class="col-md-9">-->
<!--                                                    <input id="no_disposisi" type="text" class="form-control" name="no_disposisi">-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                        </div>-->
                                        <!--<div class="form-group">
...
//                destroy: true,
                ...
                "serverSide": true,
                "ajax": {
                    url: '<?php echo base_url("index.php/tubkd/get_data_table"); ?>/2',
                    type: "post",
                     data: {
