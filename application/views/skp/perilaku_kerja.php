            ...
            <div class="ibox-content">
            	<div class="row">
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-content text-center p-md">
                                    <h2><span class="text-navy">BUKU CATATAN PENILAIAN PERILAKU PNS</span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <thead>
                        <tr>
                            <th width="27">No</th>
                            <th width="169">Tanggal</th>
                            <th colspan="4">Uraian</th>
                            <th width="177">
                                <p>Nama/Nip &amp; Paraf</p><br/>
                                    <?=$infoUser->NIP18;?>
                                </p>
                                <p>Pejabat Penilai<br/>
                                    <?=$infoUserAtasan->NAMA_ABS;?>
                                </p>
                            </th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>1</th>
                            <th>Januari s/d Desember 2018</th>
                            <th colspan="4"><p>Penilaian SKP Penilaian SKP sampai dengan akhir Desember 2014 = 84.24 </p>
                            <p>Sedangkan penilaian perilaku kerjanya adalah, sebagai berikut:</p></th>
                            <th>&nbsp;</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <tr>
                            <td rowspan="8">&nbsp;</td>
                            <td rowspan="8">&nbsp;</td>
                            <td width="264">Orientasi Pelayanan</td>
                            <td height="28" width="26">=</td>
                            <td width="38">85.00</td>
                            <td width="59">(Baik)</td>
                            <td rowspan="4" valign="top" align="center">Kasubbid Kinerja Pegawai</td>
                        </tr>
                        <tr>
                            <td>Integritas</td>
                            <td height="28">=</td>
                        ...
                        <tr>
                            ...
                            <td>84.00</td>
                            <td>(Baik)</td>
                            <td width="177" rowspan="4" align="center">
                                <p style="text-decoration: underline;"><?=$infoUser->NAMA_ABS;?></p>
                                <br/>
                                <p> <?=$infoUser->NIP18;?></p>
                            </td>
                        </tr>
