	...
	<div class="row border-bottom">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                    <a id="abc" href="<?php echo base_url(); ?>index.php/login/logout">
                        <i class="fa fa-sign-out"></i> Keluar
                    </a>
                </li>
                <?php 
                if ($this->session->userdata('logged_in')['id']=='bkd04' || $this->session->userdata('logged_in')['id']=='develop' || $this->session->userdata('logged_in')['id']=='batch'):
                ?>
                <li class="dropdown">
 ...
 <script type="text/javascript">
 	$(document).ready(function(){
		...
		function mmode()
		{
			mmode_val = ($('#mmode').is(':checked'))?'on':'off';
			$.ajax({
            url: '<?php echo base_url("index.php/maintenance/setMode"); ?>',
            type: "post",
            data: {mode:mmode_val},
            dataType: 'json',
            beforeSend: function() {
