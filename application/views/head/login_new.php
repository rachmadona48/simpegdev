                    ...
                    <div class="ibox-content" style="height:50%">
                        ...
                        <form id="defaultForm" method="POST" class="form-horizontal" role="form" name="login" >
                             <div class="form-group">                            
                                <div class="col-lg-12">
                                    <input type="text" class="form-control" name="username" placeholder="NRK" id="nrk" value="adminDKI16"/>
                                </div>
                            </div>                        
                            <div class="form-group">                            
                                <div class="col-lg-12">
                                    <input type="password" class="form-control" name="password" placeholder="Password" value="222222"/>
                                </div>
                            </div>           
...
<!--<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/lib-1.0.0.js"></script>-->
    ...
    $.ajax({
      type:"GET",
      url: "<?=site_url('index.php/login/load_captcha/1')?>",
