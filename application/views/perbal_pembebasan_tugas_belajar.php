...
<table border="0" width="100%">
	<tbody>
		<tr>
			...
			<td width="75%" align="justify">bahwa berdasarkan hasil penelitian administrasi dan Keputusan

Gubernur Nomor $keputusan_gub tentang $tentang, dan untuk kepentingan dinas perlu

membebaskan sementara Pegawai Negeri Sipil atas nama $nama_pegawai NIP/NRK

$nip/$nrk Pangkat/Golongan Ruang $pangkat/$golongan dari jabatan fungsional $(Nama Jenis Jabatan Fungsional) pada $(Nama SKPD) Provinsi Daerah
...
Khusus Ibukota Jakarta;</td>
		...
		<tr>
			...
			<td valign="top">&nbsp;</td>
			<td valign="top">b.</td>
			<td align="justify">bahwa sesuai ketentuan Pasal $pasal Peraturan Menteri Pendayagunaan Aparatur

Negara Nomor $nomor tentang Jabatan Fungsional $(Nama Jenis Jabatan

Fungsional) dan angka kreditnya, dinyatakan bahwa $(Nama Jenis Jabatan

Fungsional) dibebaskan sementara dari jabatannya apabila menjalani Tugas

Belajar lebih dari (6 (enam) bulan;</td>
		</tr>
...
$this->pdf_report3->Output('perbal_pembebesan_tubel.pdf', 'I');
