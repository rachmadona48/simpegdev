<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
        <h2>Kode Tingkat Pendidikan Perjenjangan</h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Ref</a>
            </li>
            <li class="active">
                <strong>Kode Tingkat Pendidikan Perjenjangan</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title navy-bg">
					<h5>Kode Tingkat Pendidikan Perjenjangan</h5>
		...
		<script type="text/javascript" language="javascript" >
     	 ...
     	 $(document).ready(function() {	
				...
				var dataTable = $('#employee-grid').DataTable( {
					...
					"ajax":{
						url :"<?php echo base_url(); ?>index.php/ref/ref_kodikj/data", // json datasource
