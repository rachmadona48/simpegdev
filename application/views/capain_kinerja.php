...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
         ...
         <small><i>(Menu untuk menampilkan Capaian Kinerja)</i></small>
    </div>
</div>
...
<script type="text/javascript">
        ...
        $('#go').click(function(e){
            ...
            $.ajax({
                type:'GET',
                url: "<?php echo base_url(); ?>cek_capaian/kontent"+a,
        ...
        function capaian_kinerja_detail() {
            var b = $("#monthyear").val();
            var dt = b.split(" ");
            var m = dt[0];
            var y = dt[1];
            ...
            $.ajax({
                type:'GET',
                url: "<?php echo base_url(); ?>cek_capaian/kontent",
                success:function(msg){
                 $("#content_utama").html(msg);
                },
                error: function(result)
