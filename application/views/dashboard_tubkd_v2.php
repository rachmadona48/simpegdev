        ...
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <h5>Bidang Pengembangan</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins"><?=$jml_permohonan_bidpengembangan?></h1>
                    <a href="<?=site_url('tubkd/subDashboardPengembangan1')?>"> <div class="stat-percent font-bold text-success">Lihat <i class="fa fa-level-down text-success"></i></div></a>
        ...
        <div class="col-lg-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <h5>Bidang Pengendalian</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">0</h1>
                    <a href=""> <div class="stat-percent font-bold text-warning">Lihat <i class="fa fa-level-down text-warning"></i></div></a>
                    <small>Permohonan</small>
                </div>
            </div>
        </div>
