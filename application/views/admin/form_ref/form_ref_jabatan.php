...
<form id="defaultForm2" name="defaultForm2" action="javascript:submit();" method="post" class="form-horizontal" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">      
    ...
    <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group pickerpicker">
                        ...
                        <div class="col-sm-7">
                            <input type="text" id="najabs" name="najabs" placeholder="Nama Jabatan" maxlength="150" value="<?php echo isset($isian->NAJABS) ? $isian->NAJABS : ""; ?>" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group pickerpicker">
                        ...
                        <div class="col-sm-7">
                            <input type="text" id="najabl" name="najabl" placeholder="Nama Jabatan Lengkap" maxlength="150" value="<?php echo isset($isian->NAJABL) ? $isian->NAJABL : ""; ?>" class="form-control">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group pickerpicker">
                        <label class="col-sm-5 control-label">Point 409</label>
                        <div class="col-sm-7">
                            <input type="text" id="point_409" name="point_409" placeholder="Point 409" maxlength="5" onkeypress="return numbersonly(this, event)" value="<?php echo isset($isian->POINT_409) ? $isian->POINT_409 : ""; ?>" class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group pickerpicker">
                        <label class="col-sm-5 control-label">TKD 409</label>
                        <div class="col-sm-7">
                            <input type="text" id="tkd_409" name="tkd_409" placeholder="Point" maxlength="10" onkeypress="return numbersonly(this, event)" value="<?php echo isset($isian->TKD_409) ? $isian->TKD_409 : ""; ?>" class="form-control">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group pickerpicker">
                        <label class="col-sm-5 control-label">Peringkat_409</label>
                        <div class="col-sm-7">
                            <input type="text" id="peringkat_409" name="peringkat_409" placeholder="Peringkat 409" maxlength="4" value="<?php echo isset($isian->PERINGKAT_409) ? $isian->PERINGKAT_409 : ""; ?>" class="form-control">
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group pickerpicker">
                        <label class="col-sm-5 control-label">Status Aktif</label>
                        <div class="col-sm-7">
                            
                            <select class="form-control" name="aktif" id="aktif" style="width:99%">
                                <option value="">--Pilih Status Aktif--</option>
                                <option value="<?php echo isset($isian->AKTIF) ? "1" : "1"; ?>" <?php if(isset($isian->AKTIF)){ if($isian->AKTIF == "1"){ echo "selected='selected'"; }}?>>Aktif</option>
                                <option value="<?php echo isset($isian->AKTIF) ? "2" : "2"; ?>" <?php if(isset($isian->AKTIF)){ if($isian->AKTIF == "2"){ echo "selected='selected'"; }}?>>Tidak Aktif</option>
                            </select>
                        </div>
                    </div>
                </div>
 ...
 <script type="text/javascript">
   ...
   function kolokan(id){
    ...
    var config = {
        ...
        '.chosen-klk'           : {search_contains:true,no_results_text:'Oops, Data Tidak Ditemukan',width:'250px'}
    }
