...
<form id="defaultForm2" name="defaultForm2" method="post" class="form-horizontal"  action="javascript:save();" data-bv-submitbuttons="button[type='submit']" data-remote="true" data-toggle="validator" role="form">
    <div class="modal-header">
    	...
    	<h4 class="modal-title" id="myModalLabel">Form Input SK Cuti</h4>
    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                    	...
                    	<div class="col-sm-7">
                            ...
                            <input type="hidden" id="action" name="action" placeholder="NRK" class="form-control" value="<?php echo isset($action) ? $action : '' ?>" readOnly="true">
                            <input type="hidden" id="id_hist" name="id_hist" placeholder="NRK" class="form-control" value="<?php echo isset($id_hist) ? $id_hist : '' ?>" readOnly="true">
                            <input type="hidden" id="jencuti" name="jencuti" placeholder="NRK" class="form-control" value="<?php echo isset($jencuti) ? $jencuti : '' ?>" readOnly="true">
                    	</div>
                    </div>
                    ...
                    <div class="form-group pickerpicker">
                      ...
                      <div class="col-sm-7">
                         <input type="text" id="jencuti" name="jencuti" placeholder="jencuti" maxlength="20" value="<?php echo isset($jenis_cuti) ? $jenis_cuti : ""; ?>" class="form-control" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group pickerpicker" id="data_1">
                        ...
                        <div class="input-group col-sm-7">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="tmt" name="tmt" placeholder="TMT" value="<?php echo isset($infoCuti->TMT) ? date('d-m-Y', strtotime($infoCuti->TMT)) : '' ?>" class="form-control" readonly>
                        </div>
                    ...
                    <div class="form-group pickerpicker"  id="data_2">
                      ...
                      <div class="input-group col-sm-7">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="tgakhir" name="tgakhir" placeholder="Tgl. Akhir" value="<?php echo isset($infoCuti->TGAKHIR) ? date('d-m-Y', strtotime($infoCuti->TGAKHIR)) : ""; ?>" class="form-control" readonly>
                      </div>
                    </div>
 ...
 <script type="text/javascript">
            ...
            $(document).ready(function(){
                // document.getElementById("jencuti").disabled = true;
            ...
            function save()
            {
                ...
                url = "<?php echo site_url('home/ajax_save_cuti_sk')?>";
