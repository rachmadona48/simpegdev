            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group pickerpicker" id="data_2" style="display: none">
                        ...
                        <div class="input-group col-sm-7 date">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="tgakhir" name="tgakhir" placeholder="Tgl. Akhir" value="<?php echo isset($infoJabatan->TGAKHIR) ? date('d-m-Y', strtotime($infoJabatan->TGAKHIR)) : ""; ?>" class="form-control" readonly="readonly">
                            <input type="hidden" id="tgakhirtemp" name="tgakhirtemp" placeholder="Tgl. Akhir" value="<?php echo isset($infoJabatan->TGAKHIR) ? date('d-m-Y', strtotime($infoJabatan->TGAKHIR)) : ""; ?>" class="form-control" readonly="readonly">
                        </div>
                    </div>
...
$(document).ready(function(){   
   ...
   $('#defaultForm2').bootstrapValidator({
    ...
    $("#kolok").on("change", function(event) {
        ...
        $("#jensk").on("change", function(event) {
                    event.preventDefault();
                    var jenskval = $('#jensk').val();
                    if(jenskval == '33')
                    {
                        document.getElementById('data_2').style.display = "";
                        var temptgakhir = $('#tgakhirtemp').val();
                        $('#tgakhir').val(temptgakhir);
