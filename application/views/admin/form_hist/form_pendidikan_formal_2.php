    ...
    <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group pickerpicker"  id="divkdstlu">
                            <label class="col-sm-4 control-label">Memiliki Sertifikat PI/PP/UDIN</label>
                            <div class="input-group col-sm-7">
                                <div class="i-checks inline"><label> <input type="radio" name="kdstlu" <?php echo isset($infoPendidikan->KD_STLU) ? ($infoPendidikan->KD_STLU == 'Y' ? 'checked' : '') : ''; ?> value="Y"  onclick="onchangestlu()"> <i></i> Ya </label></div>&nbsp;&nbsp;&nbsp;
                                <div class="i-checks inline"><label> <input type="radio" name="kdstlu" <?php echo isset($infoPendidikan->KD_STLU) ? ($infoPendidikan->KD_STLU == 'N' ? 'checked' : '') : ''; ?> value="N" onclick="onchangestlu()"> <i></i> Tidak </label></div>
                            </div>
                    </div>
            
                    <div id="stludiv">
                         <div class="form-group pickerpicker" id="data_7123" >
                            <label class="col-sm-4 control-label">Tgl. STLU</label>
                             <div class="input-group col-sm-7 date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="tgstlu" name="tgstlu" placeholder="Tgl. STLU" value="<?php echo isset($infoPendidikan->TG_STLU) ? date('d-m-Y', strtotime($infoPendidikan->TG_STLU)) : ""; ?>" class="form-control" readonly="readonly">
                              </div>
                        </div>
                     
            
                    
                        <div class="form-group pickerpicker" id="data_77no" >
                            <label class="col-sm-4 control-label">No. STLU</label>
                            <div class="input-group col-sm-7">
                                <input type="text" id="nostlu" name="nostlu" maxlength="50" placeholder="No. STLU" value="<?php echo isset($infoPendidikan->NO_STLU) ? $infoPendidikan->NO_STLU : ""; ?>" class="form-control">
                            </div>
                        </div>
                    </div>
...
$(document).ready(function(){
   ...
   var kdstlu =  $('input:radio[name=kdstlu]:checked').val();
   if(kdstlu == "Y" )
   {
        ...
        fields: {
            ...
            tgstlu: {
                validators: {
                    ...
                    notEmpty: {
                        message: 'Tanggal STLU tidak boleh kosong'
                    }
                }
            },
            nostlu: {
                validators: {
                     notEmpty: {
                        message: 'Nomor STLU tidak boleh kosong'
                    } 
                }
            },
            stat_app: {
   ...
   else
   {
        ...
        if($('#kodik').val()>2000)
        {
            document.getElementById('divkdstlu').style.display = "";    
             document.getElementById('data_7123').style.display = "none";
            document.getElementById('data_77no').style.display = "none";  
        }
        else
        {
            document.getElementById('divkdstlu').style.display = "none";
            document.getElementById('data_7123').style.display = "none";
            document.getElementById('data_77no').style.display = "none";    
        }
    ...
    $('#data_7123 .input-group.date').datepicker({
        todayBtn: "linked",
        keyboardNavigation: false,
        forceParse: false,
        calendarWeeks: true,
        ...
        endDate: new Date()
            ...
            // Revalidate the date field
            $('#defaultForm2').bootstrapValidator('revalidateField', 'tgstlu');
        });
...
function showSTLU()
{
    ...
    var kodik = document.getElementById('kodik').value;
    ...
    if(kodik == "" || kodik == null)
    {
        ...
        $('#tgstlu').val('');
        $('#nostlu').val('');
         $('input:radio[name=kdstlu]:checked').prop('checked', false);
    }
    else
    {
        var jenjang = kodik.substr(0,1);

        //if(jenjang == '0' || jenjang == '1' || jenjang == '2' || jenjang == '4')
         if(kodik<2000)
        {
            document.getElementById('data_7123').style.display = "none";
            document.getElementById('data_77no').style.display = "none";
        ...
        {
            document.getElementById('data_7123').style.display = "";
            document.getElementById('data_77no').style.display = "";
        }    
    }
...
function showkdstlu()
{
    ...
    var jenjang =document.getElementById('jenpdk').value; 
    var kodik = document.getElementById('kodik').value;
    ...
    {
         if(kodik == "" || kodik == null || kodik<2000)
        {
            document.getElementById('divkdstlu').style.display = "none";
            $('#tgstlu').val('');
            $('#nostlu').val('');
