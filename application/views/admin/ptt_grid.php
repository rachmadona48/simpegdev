...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
        ...
        <ol class="breadcrumb">
         ...
         <small><i>(Menu untuk menampilkan data PTT)</i></small>
    </div>
    <div class="col-lg-2">
				...
				<div class="ibox-content">
					<form role="form" action="#" method="POST" class="form-inline" return="false" id="form_search">
						...
						<div class="input-group">
							<select name="koloksrc" id="koloksrc" data-placeholder="---------------  Pilih Lokasi Kerja  ---------------" class="chosen-select-deselect" style="width:350px;" tabindex="2">
                            <option value=""></option>
							...
							<?php
								foreach ($koloks as $klk){
									echo '<option value="'.$klk->KOLOK.'">'.$klk->NALOKL.'</option>';
								}
							?>
							</select>
						...
						<div class="input-group">
							<input type="text" id="pttsrc" name="pttsrc" class="form-control" maxlength="50" style="width:350px" placeholder="MASUKKAN NPTT / NAMA ">
							<input type="hidden" name="pttsrc" id="pttsrc" value="<?php echo isset($pttsrc) ? $pttsrc : '' ;?>">
						</div>
						...
						<div class="input-group">
							<span><input type="button" name="enter" value="Go" class="btn btn-primary" onclick="cari2()"></span>
...
<!--						</a>-->
				...
				<div class="ibox-content">
					...
					<a href="<?php echo site_url(); ?>/master_ptt/doadd/" class="btn btn-sm btn-primary pull-right m-t-n-xs">
						<strong>Tambah PTT</strong>
					</a>&nbsp;
					<?php } ?>
					-->
		...
		<script type="text/javascript" language="javascript" >
            ...
            function cari2(){
				...
				var dataTable = $('#tbl-grid').DataTable( {
                    ...
                    "ajax":{
                        url :"<?php echo site_url('index.php/master_ptt/data')?>", // json datasource
                        ...
                        beforeSend: function(){
                            $('#spinner_tbl-grid').html(spinner);
                        },complete: function(){
                                 $("#spinner_tbl-grid").html('');
                        },
                        error: function(){  // error handling
                            $(".tbl-grid-error").html("");
                            $("#tbl-grid").append('<tbody class="tbl-grid-error"><tr><div colspan=9>Tidak Ada Data</div></tr></tbody>');
			...
			$(document).ready(function() {
				...
				?>
						swal("Sukses!", "Data PTT berhasil diubah.", "success");
				<?php
					}
				?>
				...
				var dataTable = $('#tbl-grid').DataTable( {
					...
					"ajax":{
						url :"<?=site_url('master_ptt/data')?>", // json datasource
						type: "post",  // method  , by default get
						"data": function ( d ) {
							// d.kolok = $('#kolok').val();
							// d.nrk = $('#nrk').val();
