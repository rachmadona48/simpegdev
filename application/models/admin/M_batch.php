<?php 
 ...
 class M_batch extends CI_Model {  
    ...
    public function getGaji_Lain()
    {
        ...
        // getting total number records without any search
        $sql = "SELECT * FROM (
                    SELECT ROWNUM AS RN,THBL,NRK,NAMA,NJTUNDABERSIH,NJUMBERGAJI,JNS_PENGHASILAN,TABELID
    ...
    public function execute_ptt(){
        ...
        {
            //$sql = "CALL GAJI_PTT_AKTIF_NOPARAM() ";
    ...
    public function cek_data_tpp13($thbl){
        $sql = "SELECT COUNT(*) AS JML
                FROM PERS_TPP_PTT
                WHERE THBL = '".$thbl."' ";
        // echo $sql; exit();
    ...
    public function exc_tpp13($th){
        $sql = "CALL DN_TPP_PTT_13('".$th."')";
    ...
    public function ceksudah($tgl_batch)
    {
        $sql = "SELECT DISTINCT(TGL_PUBLISH) from LOG_REKAP_PENGHASILAN_NEW where TO_CHAR(TGL_PUBLISH,'DD-MM-YYYY')='".$tgl_batch."'";
        $query = $this->prod->query($sql);
    ...
    public function exc_rekap_hasil_tglpub($tgl_batch)
    {
        
        $sql = "call CEKREKAPPENGHASILANPERTGLPUB1('".$tgl_batch."') ";
    ...
    public function pindahkehist($tgl_batch)
    {
         $sql = "SELECT DISTINCT(TGL_PUBLISH) from LOG_REKAP_PENGHASILAN_NEW where TO_CHAR(TGL_PUBLISH,'DD-MM-YYYY')='".$tgl_batch."'";
        $query = $this->prod->query($sql);
        ...
        if($num>0)
        {
            $sql2 = "INSERT INTO LOG_REKAP_PENGHASILAN_NEW_HIST(select * from LOG_REKAP_PENGHASILAN_NEW where TO_CHAR(TGL_PUBLISH,'DD-MM-YYYY')='".$tgl_batch."' )";
            $query2 = $this->prod->query($sql2);

            /*$sql3 = "DELETE FROM LOG_REKAP_PENGHASILAN_NEW WHERE TO_CHAR(TGL_PUBLISH,'DD-MM-YYYY')='".$tgl_batch."'";
            $query3 = $this->prod->query($sql3);*/

            $sql3 = "SELECT DISTINCT(ID_CEK) FROM LOG_REKAP_PENGHASILAN_NEW WHERE TO_CHAR(TGL_PUBLISH,'DD-MM-YYYY')='".$tgl_batch."' ";
            $query3 = $this->prod->query($sql3)->row();

            $id= $query3->ID_CEK;
            
            $sql4 = "UPDATE LOG_REKAP_PENGHASILAN_NEW SET TGL_PUBLISH = '' WHERE ID_CEK = '$id'";
            $query4 = $this->prod->query($sql4);

        }
    }

    public function exc_rekap_hasil_hariini()
    {
        
        $sql = "call CEKREKAPPENGHASILANHARIINI1() ";
    ...
    //1
    public function showDataRekap1()
    {
        $sql ="SELECT DISTINCT to_char(TGL_PUBLISH,'DD-MM-YYYY')TGL_PUBLISH,to_char(WAKTU_MULAI_EKSEKUSI,'DD-MM-YYYY HH24:MI:SS')WAKTU_MULAI,VJUMLAHREKAP,VJUMLAHRUTIN,ID_CEK FROM LOG_REKAP_PENGHASILAN_NEW
                WHERE ID_CEK = (SELECT MAX(ID_CEK)ID_CEK FROM LOG_REKAP_PENGHASILAN_NEW) AND WAKTU_MULAI_EKSEKUSI IS NOT NULL";
        /*$sql ="SELECT DISTINCT to_char(TGL_PUBLISH,'DD-MM-YYYY')TGL_PUBLISH,to_char(WAKTU_MULAI_EKSEKUSI,'DD-MM-YYYY HH24:MI:SS')WAKTU_MULAI,VJUMLAHREKAP,VJUMLAHRUTIN,ID_CEK FROM LOG_REKAP_PENGHASILAN_NEW
                WHERE ID_CEK = 1 AND WAKTU_MULAI_EKSEKUSI IS NOT NULL";*/
    ...
    public function showdataRutinLebih($id)
    {
        $sql = "SELECT * FROM LOG_REKAP_PENGHASILAN_NEW
                WHERE ID_CEK = '$id'
                AND TIPE_LOG = '1'
                ORDER BY NOURUT ASC";
    ...
    public function showCekSelisih($id)
    {
        $sql = "SELECT ID_CEK,CEK_SELISIH FROM LOG_REKAP_PENGHASILAN_NEW
                WHERE ID_CEK = '$id'
                and CEK_SELISIH IS NOT NULL
                ORDER BY NOURUT ASC";
        $query = $this->prod->query($sql);
    ...
    public function showdetailRekap($id)
    {
        $sql = "SELECT ID_CEK,THBL,WAKTU,TGL_PUBLISH,JENIS,JUMLAH,MACAM FROM LOG_REKAP_PENGHASILAN_NEW
                WHERE ID_CEK = '$id'
                AND TIPE_LOG = '2'
                ORDER BY NOURUT ASC";
    ...
    public function showjumlahSIPKD($id)
    {
        $sql = "SELECT DISTINCT VJUMLAHSIPKD,VJUMLAHREKAP FROM LOG_REKAP_PENGHASILAN_NEW WHERE ID_CEK='$id' AND VJUMLAHSIPKD IS NOT NULL";
    ...
    public function cekVerror($id)
    {
        $sql = "SELECT V_ERROR FROM LOG_REKAP_PENGHASILAN_NEW WHERE ID_CEK = '$id' AND V_ERROR IS NOT NULL";
    ...
    public function getwaktuAkhir($id)
    {
        $sql = "SELECT to_char(WAKTU_AKHIR_EKSEKUSI,'DD-MM-YYYY HH24:MI:SS')WAKTU_AKHIR FROM LOG_REKAP_PENGHASILAN_NEW 
        WHERE ID_CEK = '$id' AND WAKTU_AKHIR_EKSEKUSI IS NOT NULL";
