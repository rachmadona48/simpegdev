...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
        ...
        .state('tables.data_skpd', {
            url: "/data_skpd",
            templateUrl: "views/table_data_skpd.html",
            data: { pageTitle: 'Data SKPD' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('tables.data_dpa', {
            url: "/data_dpa",
            templateUrl: "views/table_data_dpa.html",
            data: { pageTitle: 'Data DPA by SKPD' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
