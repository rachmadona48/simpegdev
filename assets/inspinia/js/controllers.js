 ...
 */	this.skpds = [
        {
            id: '2.02.002',
            skpdName: 'Pusat Produksi, Inspeksi dan Sertifikasi Hasil Perikanan',
            kepalaName: 'Ir. RIANA FAIZA, M.Si'
        },
        {
            id: '1.01.022',
            skpdName: 'Sudin Pendidikan Menengah   - JAKUT',
            kepalaName: ''
        }
...
/*                 case 'getDataTable':
                    $aColumns = array('menu_id','menu','menu_link','menu_parent','status','menu_id');
                    $sTable = 'menu';
                    $data = $this->common->dataTable($aColumns,$sTable);
